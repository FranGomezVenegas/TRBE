...
import com.labplanet.servicios.moduleenvmonit.EnvMonIncubBatchAPIfrontend;
        ...
        try {
            ...
            switch (endPoint) {
                case GET_SAMPLE_ANALYSIS_LIST:
                    ...
                    String[] tblFldsToGet = EnumIntTableFields.getAllFieldNamesFromDatabase(TblsData.TablesData.SAMPLE_ANALYSIS.getTableName(), "ALL");
                    EnumIntTableFields[] tblFldsToGetObj=EnumIntTableFields.getTableFieldsFromString(TblsData.TablesData.SAMPLE_ANALYSIS, tblFldsToGet);
                ...
                case GET_SAMPLE_ANALYSIS_RESULT_LIST_SECONDENTRY:
                    ...
                    Integer posicLimitIdFld = LPArray.valuePosicInArray(fldsToGet, TblsData.ViewSampleAnalysisResultWithSpecLimits.LIMIT_ID.getName());
                    ...
                    if (LPPlatform.LAB_FALSE.equalsIgnoreCase(analysisResultList[0][0].toString())) {
                        ...
                        Object[] objectsIds = getObjectsId(EnumIntViewFields.getAllFieldNames(fldsToGetObj), analysisResultList, "-");
                        ...
                        for (Object[] curRow : analysisResultList) {
                            ...
                            String[] allFieldNames = EnumIntViewFields.getAllFieldNames(fldsToGetObj);
                            Object[] resultWarningData = warningByMinOrMaxAllowed(EnumIntViewFields.getAllFieldNames(fldsToGetObj), curRow);
                            ...
                            Object[] resultLockData = sampleAnalysisResultLockData(procInstanceName, EnumIntViewFields.getAllFieldNames(fldsToGetObj), curRow);
                            ...
                            row = LPJson.convertArrayRowToJSONObject(EnumIntViewFields.getAllFieldNames(fldsToGetObj), curRow);
