...
public class TblsEnvMonitConfig {
        ...
        PROG_SCHED_LOCATIONS_VIEW(" select  dpr.sample_config_code, dpr.sample_config_code_version, "
                ...
                new EnumIntTablesJoin[]{
                    new EnumIntTablesJoin(TablesEnvMonitConfig.PROGRAM, "dpr", TablesEnvMonitConfig.PROGRAM_CALENDAR_DATE, "cnfpcd", true,
                            new EnumIntTableFields[][]{{null, null}}, " dpr." + TblsEnvMonitConfig.Program.NAME.getName() + "::text = cnfpcd." + TblsEnvMonitConfig.ProgramCalendarDate.PROGRAM_CONFIG_ID.getName() + "::text ",
                    ...
                    new EnumIntTablesJoin(TablesEnvMonitConfig.PROGRAM_CALENDAR_DATE, "cnfpcd", TablesEnvMonitConfig.PROGRAM_LOCATION, "dpl", true,
                            new EnumIntTableFields[][]{{null, null}}, "cnfpcd." + TblsEnvMonitConfig.ProgramCalendarDate.PROGRAM_CONFIG_ID.getName() + "::text=" + "dpl." + TblsEnvMonitConfig.ProgramLocation.PROGRAM_NAME.getName() + "::text ",
    ...
    public enum ProgramLocation implements EnumIntTableFields {
        ...
        REQ_SAMPLING_END("requires_tracking_sampling_end", LPDatabase.booleanFld(), null, null, null, null), //        , PROGRAM_CONFIG_VERSION("program_config_version", LPDatabase.String())
        // ...
        ;
    ...
    public enum IncubBatch implements EnumIntTableFields {
        ...
        STRUCT_COLS_NAME("struct_cols_name", "character varying[] COLLATE pg_catalog.\"default\"", null, null, null, null), // ** Not in use, it is present in the data repository, not in config
        //STAGE("stage", LPDatabase.stringNotNull(), null, null, null, null),
    ...
    public enum ViewProgramScheduledLocations implements EnumIntViewFields {
        SAMPLE_CONFIG_CODE("dpr", "sample_config_code", "dpr.sample_config_code", Program.SAMPLE_CONFIG_CODE, null, null, null),
        SAMPLE_CONFIG_CODE_VERSION("dpr", "sample_config_code_version", "dpr.sample_config_code_version", Program.SAMPLE_CONFIG_CODE_VERSION, null, null, null),
        PROGRAM_NAME("dpl", "program_name", "dpl.program_name as program_name", Program.NAME, null, null, null),
        PROGRAM_DAY_ID("cnfpcd", "program_day_id", "cnfpcd.id as program_day_id", TblsEnvMonitConfig.ProgramCalendarDate.CALENDAR_ID, null, null, null),
        PROGRAM_DAY_DATE("cnfpcd", "program_day_date", "cnfpcd.date as program_day_date", TblsEnvMonitConfig.ProgramCalendarDate.DATE, null, null, null),
        AREA("dpl", "area", "dpl.area", TblsEnvMonitConfig.ProgramLocation.AREA, null, null, null),
        SPEC_CODE("dpl", "spec_code", "dpl.spec_code", TblsEnvMonitConfig.ProgramLocation.SPEC_CODE, null, null, null),
        SPEC_CODE_VERSION("dpl", "spec_code_version", "dpl.spec_code_version", TblsEnvMonitConfig.ProgramLocation.SPEC_CODE_VERSION, null, null, null),
        SPEC_VARIATION_NAME("dpl", "spec_variation_name", "dpl.spec_variation_name", TblsEnvMonitConfig.ProgramLocation.SPEC_VARIATION_NAME, null, null, null),
        SPEC_ANALYSIS_VARIATION("dpl", "spec_analysis_variation", "dpl.spec_analysis_variation", TblsEnvMonitConfig.ProgramLocation.SPEC_ANALYSIS_VARIATION, null, null, null),
        REQUIRES_PERSON_ANA("dpl", "requires_person_ana", "dpl.requires_person_ana", TblsEnvMonitConfig.ProgramLocation.REQUIRES_PERSON_ANA, null, null, null),
        PERSON_ANA_DEFINITION("dpl", "person_ana_definition", "dpl.person_ana_definition", TblsEnvMonitConfig.ProgramLocation.PERSON_ANA_DEFINITION, null, null, null),
        LOCATION_NAME("cnfpcd", "location_name", "cnfpcd.location_name", TblsEnvMonitConfig.ProgramLocation.LOCATION_NAME, null, null, null),
        ID("cnfpcd", "id", "cnfpcd.id", TblsEnvMonitConfig.ProgramCalendarDate.CALENDAR_ID, null, null, null),
        SAMPLE_ID("cnfpcd", "sample_id", "cnfpcd.sample_id", TblsEnvMonitConfig.ProgramCalendarDate.SAMPLE_ID, null, null, null),
        PROGRAM_CONFIG_ID("cnfpcd", "program_config_id", "cnfpcd.program_config_id", TblsEnvMonitConfig.ProgramCalendarDate.PROGRAM_CONFIG_ID, null, null, null),
        DATE("cnfpcd", "date", "cnfpcd.date", TblsEnvMonitConfig.ProgramCalendarDate.DATE, null, null, null),;

        private ViewProgramScheduledLocations(String tblAliasInView, String name, String vwAliasName, EnumIntTableFields fldObj, String fldMask, String comment, FldBusinessRules[] busRules) {
            this.fldName = name;
