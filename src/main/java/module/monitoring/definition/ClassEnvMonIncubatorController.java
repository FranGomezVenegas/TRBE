...
public class ClassEnvMonIncubatorController implements ActionsClass{
    ...
    public ClassEnvMonIncubatorController(HttpServletRequest request, HttpServletResponse response, String actionName, Object[][] testingContent, Integer iLines, Integer table1NumArgs, Integer auditReasonPosic) {
    ...
    @Override public void initializeEndpoint(String actionName) {
        try {
            this.enumConstantByName = EnvMonIncubatorAPIactionsEndpoints.valueOf(actionName.toUpperCase());
    ...
    @Override    public void createClassEnvMonAndHandleExceptions(HttpServletRequest request, String actionName, Object[][] testingContent, Integer iLines, Integer table1NumArgs, Integer auditReasonPosic) {
        ClassEnvMonIncubator clss = null;
        try {            
            EnvMonIncubatorAPIactionsEndpoints endPoint = EnvMonIncubatorAPIactionsEndpoints.valueOf(actionName.toUpperCase());
            ...
            clss = new ClassEnvMonIncubator(request, endPoint);
