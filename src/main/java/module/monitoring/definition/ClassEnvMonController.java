 ...
 * @author User
 */
public class ClassEnvMonController implements ActionsClass{
    ...
    public ClassEnvMonController(HttpServletRequest request, HttpServletResponse response, String actionName, Object[][] testingContent, Integer iLines, Integer table1NumArgs, Integer auditReasonPosic) {
    ...
    @Override public void initializeEndpoint(String actionName) {
        try {
            this.enumConstantByName = EnvMonAPI.EnvMonAPIactionsEndpoints.valueOf(actionName.toUpperCase());
    ...
    @Override    public void createClassEnvMonAndHandleExceptions(HttpServletRequest request, String actionName, Object[][] testingContent, Integer iLines, Integer table1NumArgs, Integer auditReasonPosic) {  
        ClassEnvMon clss = null;
        try {            
            EnvMonAPI.EnvMonAPIactionsEndpoints endPoint = EnvMonAPI.EnvMonAPIactionsEndpoints.valueOf(actionName.toUpperCase());
            ...
            clss = new ClassEnvMon(request, endPoint);
