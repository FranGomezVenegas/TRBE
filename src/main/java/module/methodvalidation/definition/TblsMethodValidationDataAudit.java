 ...
 * @author User
 */
public class TblsMethodValidationDataAudit {
    private static final java.lang.String SCHEMA_NAME = GlobalVariables.Schemas.DATA_AUDIT.getName();    
    public enum TablesMethodValidationDataAudit implements EnumIntTables{        
        PARAMETER(null, "project", SCHEMA_NAME, true, Parameter.values(), Parameter.AUDIT_ID.getName(), 
            new String[]{Parameter.AUDIT_ID.getName()}, null, "Project table"),
        ;
        private TablesMethodValidationDataAudit(FldBusinessRules[] fldBusRules, String dbTblName, String repositoryName, Boolean isProcedure, EnumIntTableFields[] tblFlds, 
    ...
    public enum Parameter implements EnumIntTableFields{
        ...
        ;
        private Parameter(String dbObjName, String dbObjType, String fieldMask, ReferenceFld refer, String comment,
