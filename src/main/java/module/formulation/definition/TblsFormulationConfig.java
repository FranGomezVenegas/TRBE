...
import module.instrumentsmanagement.definition.*;
 ...
 */
public class TblsFormulationConfig {
    ...
    public enum InstrumentsFamily implements EnumIntTableFields{
        ...
        CALIB_REQUIRED("calib_required", LPDatabase.booleanFld(false), null, null, null, null),
        CALIB_INTERVAL("calib_interval", LPDatabase.string(), null, null, null, null),
        CALIB_TURN_OFF_WHEN_STARTED("calib_turn_off_when_started", LPDatabase.booleanFld(), null, null, null, null),
        CALIB_TURN_ON_WHEN_COMPLETED("calib_turn_on_when_completed", LPDatabase.booleanFld(), null, null, null, null),
        CALIB_VARIABLES_SET("calib_variables_set", LPDatabase.string(), null, null, null, null),
        CALIB_CREATE_NWEV_WHEN_EXPIRES("calib_system_create_new_event_when_expires", LPDatabase.booleanFld(false), null, null, null, null),
        CALIB_SCHED_CREATE_OFFSET_INTVL("calib_sched_create_offset_days", LPDatabase.integer(), null, null, null, null),
        PM_REQUIRED("pm_required", LPDatabase.booleanFld(false), null, null, null, null),
        ...
        PM_CREATE_NEV_WHEN_EXPIRES("pm_system_create_new_event_when_expires", LPDatabase.booleanFld(false), null, null, null, null),
        PM_SCHED_CREATE_OFFSET_INTVL("pm_sched_create_offset_days", LPDatabase.integer(), null, null, null, null),
        VERIF_SAME_DAY_REQUIRED("verif_same_day_required", LPDatabase.booleanFld(false), null, null, null, null),
        VERIF_SAME_DAY_VARIABLES_SET("verif_same_day_variables_set", LPDatabase.string(), null, null, null, null),
        SERVICE_REQUIRED("service_required", LPDatabase.booleanFld(false), null, null, null, null),
        SERVICE_VARIABLES_SET("service_variables_set", LPDatabase.string(), null, null, null, null),
        SYSTEM_CREATE_NEW_WHEN_EXPIRES("system_create_new_event_when_expires", LPDatabase.booleanFld(false), null, null, null, null),
