 ...
 * @author User
 */
public class TblsFormulationDataAudit {
    private static final java.lang.String SCHEMA_NAME = GlobalVariables.Schemas.DATA_AUDIT.getName();    
    public enum TablesFormulationDataAudit implements EnumIntTables{        
        FORMULA(null, "formula", SCHEMA_NAME, true, Formula.values(), Formula.AUDIT_ID.getName(), 
            new String[]{Formula.AUDIT_ID.getName()}, null, "Formula table"),
        ;
        private TablesFormulationDataAudit(FldBusinessRules[] fldBusRules, String dbTblName, String repositoryName, Boolean isProcedure, EnumIntTableFields[] tblFlds, 
