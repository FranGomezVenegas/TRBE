...
public class TblsInvTrackingData {
    ...
    public enum TablesInvTrackingData implements EnumIntTables{        
        LOT(null, "lot", SCHEMA_NAME, IS_PRODEDURE_INSTANCE, TblsInvTrackingData.Lot.values(), null,
            new String[]{Lot.LOT_ID.getName(), Lot.REFERENCE.getName(), Lot.CATEGORY.getName()}, null, "lot table"),



        SAMPLE(null, "sample", SCHEMA_NAME, IS_PRODEDURE_INSTANCE, TblsInvTrackingData.Sample.values(), Sample.SAMPLE_ID.getName()
            , new String[]{Sample.SAMPLE_ID.getName()}, null, "sample table"),
        SAMPLE_MICROORGANISM(null, "sample_microorganism", SCHEMA_NAME, IS_PRODEDURE_INSTANCE, TblsInvTrackingData.SampleMicroorganism.values(), SampleMicroorganism.ID.getName()
            , new String[]{SampleMicroorganism.ID.getName()}, 
            new Object[]{new ForeignkeyFld(TblsInvTrackingData.SampleMicroorganism.SAMPLE_ID.getName(), 
                    SCHEMA_NAME, TablesInvTrackingData.SAMPLE.getTableName(), TblsInvTrackingData.SampleMicroorganism.SAMPLE_ID.getName())}
            , "SampleMicroorganism table"),
        PRODUCTION_LOT(null, "production_lot", SCHEMA_NAME, IS_PRODEDURE_INSTANCE, TblsInvTrackingData.ProductionLot.values(), null,
            new String[]{ProductionLot.LOT_NAME.getName()}, null, "ProductionLot table"),
        INSTRUMENT_INCUB_NOTEBOOK(null, "instrument_incubator_notebook", SCHEMA_NAME, IS_PRODEDURE_INSTANCE, TblsInvTrackingData.InstrIncubatorNoteBook.values(), InstrIncubatorNoteBook.ID.getName()
            , new String[]{InstrIncubatorNoteBook.ID.getName()}, null, "instrument_incubator_notebook table"),
        INCUB_BATCH(null, "incub_batch", SCHEMA_NAME, IS_PRODEDURE_INSTANCE, TblsInvTrackingData.IncubBatch.values(), null
    ...
    public enum ViewsEnvMonData implements EnumIntViews{
        SAMPLE_MICROORGANISM_LIST_VIEW(" SELECT distinct s.sample_id, s.sample_config_code, s.status, s.sampling_date, s.current_stage, s.program_name, s.location_name, s.incubation_start, s.incubation_end, s.incubation2_start, s.incubation2_end, "
            ...
            null, "sample_microorganism_list_vw", SCHEMA_NAME, true, TblsInvTrackingData.ViewSampleMicroorganismList.values(), "ViewSampleMicroorganismList", 
        new EnumIntTablesJoin[]{
            ...
            new EnumIntTablesJoin(TblsData.TablesData.SAMPLE_ANALYSIS_RESULT, "sar", TablesInvTrackingData.SAMPLE_MICROORGANISM, "sorg", true,
                new EnumIntTableFields[][]{{TblsData.SampleAnalysisResult.SAMPLE_ID, TblsInvTrackingData.SampleMicroorganism.SAMPLE_ID}}, "", JOIN_TYPES.INNER),
    ...
    public enum Lot implements EnumIntTableFields{
        LOT_ID("lot_id", LPDatabase.stringNotNull(), null, null, null, null),
