...
public class TblsInspLotRMData {
    ...
    public enum ViewsInspLotRMData implements EnumIntViews{
        SAMPLE_ANALYSIS_RESULT_WITH_SPEC_LIMITS_VIEW(" SELECT sar.result_id,\n" +
"    sar.test_id,\n" +
"    sar.sample_id,\n" +
"    sar.status,\n" +
"    sar.status_previous,\n" +
...
"            ELSE NULL::numeric\n" +
"        END AS raw_value_num,\n" +
"    sar.pretty_value,\n" +
"    sar.entered_on,\n" +
"    sar.entered_by,\n" +
"    sar.reentered,\n" +
"    sar.spec_eval,\n" +
"    sar.spec_eval_detail,\n" +
"    sar.uom,\n" +
"    sar.uom_conversion_mode,\n" +
"    sar.aliquot_id,\n" +
"    sar.subaliquot_id,\n" +
"    sar.max_dp,\n" +
"    sar.min_allowed,\n" +
"    sar.max_allowed,\n" +
"    sar.list_entry,\n" +
"    s.sample_config_code,\n" +
"    s.status AS sample_status,\n" +
"    s.current_stage,\n" +
"    s.lot_name,\n" +
"    s.bulk_name,\n" +
"    sa.status AS sample_analysis_status,\n" +
"    sa.ready_for_revision AS sample_analysis_ready_for_revision,\n" +
"    sa.testing_group,\n" +
"    s.logged_on,\n" +
"    s.logged_by,\n" +
"    s.ready_for_revision AS sample_ready_for_revision,\n" +
"    spclim.limit_id,\n" +
"    spclim.code AS spec_code,\n" +
"    spclim.config_version AS spec_config_version,\n" +
"    spclim.variation_name AS spec_variation_name,\n" +
"    spclim.analysis AS analysis_spec_limits,\n" +
"    spclim.method_name AS method_name_spec_limits,\n" +
"    spclim.method_version AS method_version_spec_limits,\n" +
"    spclim.parameter,\n" +
"    spclim.rule_type,\n" +
"    spclim.rule_variables,\n" +
"    spclim.uom AS uom_spec_limits,\n" +
"    spclim.uom_conversion_mode AS uom_conversion_mode_spec_limits,\n" +
"    spclim.min_val_allowed,\n" +
"    spclim.max_val_allowed,\n" +
"    spclim.min_allowed_strict,\n" +
"    spclim.max_allowed_strict,\n" +
"    spclim.min_undetermined,\n" +
"    spclim.max_undetermined,\n" +
"    spclim.min_undet_strict,\n" +
"    spclim.max_undet_strict,\n" +
"        CASE\n" +
"            WHEN pca.id IS NULL THEN 'NO'::text\n" +
"            ELSE 'YES'::text\n" +
"        END AS has_pre_invest,\n" +
"    pca.id AS pre_invest_id,\n" +
"        CASE\n" +
"            WHEN io.id IS NULL THEN 'NO'::text\n" +
"            ELSE 'YES'::text\n" +
"        END AS has_invest,\n" +
"    io.invest_id,\n" +
"    io.id AS invest_object_id,\n" +
"    s.reviewer AS sample_reviewer,\n" +
"    sa.reviewer AS test_reviewer "
                + "  from #SCHEMA.sample_analysis_result sar " +
                ...
                "    left outer join #SCHEMA_PROCEDURE.lot_corrective_action pca ON s.lot_name = pca.lot_name " +
...
public enum ViewSampleAnalysisResultWithSpecLimits implements EnumIntViewFields{
        LOT_NAME("s", Sample.LOT_NAME.getName(), "s.lot_name as lot_name", Sample.LOT_NAME, null, null, null),
        BULK_ID("s", Sample.BULK_ID.getName(), "s.bulk_id as bulk_id", Sample.BULK_ID, null, null, null),
        BULK_NAME("s", Sample.BULK_NAME.getName(), "s.bulk_name as bulk_name", Sample.BULK_NAME, null, null, null),
        RESULT_ID("sar", TblsData.SampleAnalysisResult.RESULT_ID.getName(), "sar.result_id as result_id", TblsData.SampleAnalysisResult.RESULT_ID, null, null, null),
        TEST_ID("sar", TblsData.SampleAnalysis.TEST_ID.getName(), "sar.test_id as test_id", TblsData.SampleAnalysisResult.TEST_ID, null, null, null),
        SAMPLE_ID("sar", TblsData.Sample.SAMPLE_ID.getName(), "sar.sample_id as sample_id", TblsData.SampleAnalysisResult.SAMPLE_ID, null, null, null),
        STATUS("sar", FIELDS_NAMES_STATUS, "sar.status as status", TblsData.SampleAnalysisResult.STATUS, null, null, null),
        STATUS_PREVIOUS("sar", FIELDS_NAMES_STATUS_PREVIOUS, "sar.status_previous as status_previous", TblsData.SampleAnalysisResult.STATUS_PREVIOUS, null, null, null),
        ANALYSIS("sar", FIELDS_NAMES_ANALYSIS, "sar.analysis as analysis", TblsData.SampleAnalysisResult.ANALYSIS, null, null, null),
        METHOD_NAME("sar", LPDatabase.FIELDS_NAMES_METHOD_NAME, "sar.method_name as method_name", TblsData.SampleAnalysisResult.METHOD_NAME, null, null, null),
        METHOD_VERSION("sar", LPDatabase.FIELDS_NAMES_METHOD_VERSION, "sar.method_version as method_version", TblsData.SampleAnalysisResult.METHOD_VERSION, null, null, null),
        REPLICA("sar", FIELDS_NAMES_REPLICA, "sar.replica as replica", TblsData.SampleAnalysisResult.REPLICA, null, null, null),
        PARAM_NAME("sar", "param_name", "sar.param_name as param_name", TblsData.SampleAnalysisResult.PARAM_NAME, null, null, null),
        PARAM_TYPE("sar", "param_type", "sar.param_type as param_type", TblsData.SampleAnalysisResult.PARAM_TYPE, null, null, null),
        MANDATORY("sar", "mandatory", "sar.mandatory as mandatory", TblsData.SampleAnalysisResult.MANDATORY, null, null, null),
        REQUIRES_LIMIT("sar", "requires_limit", "sar.requires_limit as requires_limit", TblsData.SampleAnalysisResult.REQUIRES_LIMIT, null, null, null),
        RAW_VALUE("sar", "raw_value", "sar.raw_value as raw_value", TblsData.SampleAnalysisResult.RAW_VALUE, null, null, null),
        RAW_VALUE_NUM("sar", "raw_value_num", "case when isnumeric(sar.raw_value) then to_number(sar.raw_value::text, '9999'::text) else null end as raw_value_num", TblsData.SampleAnalysisResult.REPLICA, null, null, null),
        PRETTY_VALUE("sar", "pretty_value", "sar.pretty_value as pretty_value", TblsData.SampleAnalysisResult.PRETTY_VALUE, null, null, null),
        ENTERED_ON("sar", "entered_on", "sar.entered_on as entered_on", TblsData.SampleAnalysisResult.ENTERED_ON, null, null, null),
        ENTERED_BY("sar", "entered_by", "sar.entered_by as entered_by", TblsData.SampleAnalysisResult.ENTERED_BY, null, null, null),
        REENTERED("sar", "reentered", "sar.reentered as reentered", TblsData.SampleAnalysisResult.REENTERED, null, null, null),
        SPEC_EVAL("sar", FIELDS_NAMES_SPEC_EVAL, "sar.spec_eval as spec_eval", TblsData.SampleAnalysisResult.SPEC_EVAL, null, null, null),
        SPEC_EVAL_DETAIL("sar", "spec_eval_detail", "sar.spec_eval_detail as spec_eval_detail", TblsData.SampleAnalysisResult.SPEC_EVAL_DETAIL, null, null, null),
        UOM("sar", "uom", "sar.uom as uom", TblsData.SampleAnalysisResult.UOM, null, null, null),
        UOM_CONVERSION_MODE("sar", "uom_conversion_mode", "sar.uom_conversion_mode as uom_conversion_mode", TblsData.SampleAnalysisResult.UOM_CONVERSION_MODE, null, null, null),
        ALIQUOT_ID("sar", FIELDS_NAMES_ALIQUOT_ID, "sar.aliquot_id as aliquot_id", TblsData.SampleAnalysisResult.ALIQUOT_ID, null, null, null),
        SUBALIQUOT_ID("sar", FIELDS_NAMES_SUBALIQUOT_ID, "sar.subaliquot_id as subaliquot_id", TblsData.SampleAnalysisResult.SUBALIQUOT_ID, null, null, null),
        MAX_DP("sar", "max_dp", "sar.max_dp as max_dp", TblsData.SampleAnalysisResult.MAX_DP, null, null, null),
        MIN_ALLOWED("sar", "min_allowed", "sar.min_allowed as min_allowed", TblsData.SampleAnalysisResult.MIN_ALLOWED, null, null, null),
        MAX_ALLOWED("sar", "max_allowed", "sar.max_allowed as max_allowed", TblsData.SampleAnalysisResult.MAX_ALLOWED, null, null, null),
        LIST_ENTRY("sar", "list_entry", "sar.list_entry as list_entry", TblsData.SampleAnalysisResult.LIST_ENTRY, null, null, null),
        SAMPLE_STATUS("s", "sample_status", "s.status as sample_status", TblsData.Sample.STATUS, null, null, null),
        CURRENT_STAGE("s", "current_stage", "s.current_stage as current_stage", TblsData.Sample.CURRENT_STAGE, null, null, null),
        SAMPLE_ANALYSIS_STATUS("ss", "sample_analysis_status", "sa.status as analysis_status", TblsData.SampleAnalysis.STATUS, null, null, null),
        SAMPLE_ANALYSIS_READY_FOR_REVISION("sa", "sample_analysis_"+TblsData.SampleAnalysis.READY_FOR_REVISION.getName(), "sa."+TblsData.Sample.READY_FOR_REVISION.getName()+" as  sample_analysis_"+TblsData.Sample.READY_FOR_REVISION.getName(), TblsData.SampleAnalysis.READY_FOR_REVISION, null, null, null),
        TESTING_GROUP("sa", "testing_group", "sa.testing_group as testing_group", TblsData.SampleAnalysis.TESTING_GROUP, null, null, null),
        SAMPLE_ANALYSIS_REVIEWER("sa", "sample_analysis_reviewer", "sa.reviewer as reviewer", TblsData.SampleAnalysis.REVIEWER, null, null, null),        
        LOGGED_ON("s", "logged_on", "s.logged_on as logged_on", TblsData.Sample.LOGGED_ON, null, null, null),
        ...
        LIMIT_ID("spcLim", "limit_id", "spcLim.limit_id as limit_id", TblsCnfg.SpecLimits.LIMIT_ID, null, null, null),
        SPEC_CODE("spcLim", "spec_code", "spcLim.code as code", TblsCnfg.SpecLimits.CODE, null, null, null),
        SPEC_CONFIG_VERSION("spcLim", "spec_config_version", "spcLim.config_version as config_version", TblsCnfg.SpecLimits.CONFIG_VERSION, null, null, null),
        SPEC_VARIATION_NAME("spcLim", "spec_variation_name", "spcLim.variation_name as variation_name", TblsCnfg.SpecLimits.VARIATION_NAME, null, null, null),
        ANALYSIS_SPEC_LIMITS("spcLim", "analysis_spec_limits", "spcLim.analysis as analysis", TblsCnfg.SpecLimits.ANALYSIS, null, null, null),
        METHOD_NAME_SPEC_LIMITS("spcLim", "method_name_spec_limits", "spcLim.method_name as method_name", TblsCnfg.SpecLimits.METHOD_NAME, null, null, null),
        METHOD_VERSION_SPEC_LIMITS("spcLim", "method_version_spec_limits", "spcLim.method_version as method_version", TblsCnfg.SpecLimits.METHOD_VERSION, null, null, null),
        PARAMETER("spcLim", "parameter", "spcLim.parameter as parameter", TblsCnfg.SpecLimits.PARAMETER, null, null, null),
        RULE_TYPE("spcLim", "rule_type", "spcLim.rule_type as rule_type", TblsCnfg.SpecLimits.RULE_TYPE, null, null, null),
        RULE_VARIABLES("spcLim", "rule_variables", "spcLim.rule_variables as rule_variables", TblsCnfg.SpecLimits.RULE_VARIABLES, null, null, null),
        UOM_SPEC_LIMITS("spcLim", "uom_spec_limits", "spcLim.uom as uom", TblsCnfg.SpecLimits.UOM, null, null, null),
        UOM_CONVERSION_MODE_SPEC_LIMITS("spcLim", "uom_conversion_mode_spec_limits", "spcLim.uom_conversion_mode as uom_conversion_mode", TblsCnfg.SpecLimits.UOM_CONVERSION_MODE, null, null, null),
        MIN_VAL_ALLOWED("spcLim", "min_val_allowed", "spcLim.min_val_allowed as min_val_allowed", TblsCnfg.SpecLimits.MIN_VAL_ALLOWED, null, null, null),
        MAX_VAL_ALLOWED("spcLim", "max_val_allowed", "spcLim.max_val_allowed as max_val_allowed", TblsCnfg.SpecLimits.MAX_VAL_ALLOWED, null, null, null),
        MIN_VAL_ALLOWED_IS_STRICT("spcLim", "min_allowed_strict", "spcLim.min_allowed_strict as min_allowed_strict", TblsCnfg.SpecLimits.MIN_VAL_ALLOWED_IS_STRICT, null, null, null),
        MAX_VAL_ALLOWED_IS_STRICT("spcLim", "max_allowed_strict", "spcLim.max_allowed_strict as max_allowed_strict", TblsCnfg.SpecLimits.MAX_VAL_ALLOWED_IS_STRICT, null, null, null),
        MIN_VAL_FOR_UNDETERMINED("spcLim", "min_undetermined", "spcLim.min_undetermined as min_undetermined", TblsCnfg.SpecLimits.MIN_VAL_FOR_UNDETERMINED, null, null, null),
        MAX_VAL_FOR_UNDETERMINED("spcLim", "max_undetermined", "spcLim.max_undetermined as max_undetermined", TblsCnfg.SpecLimits.MAX_VAL_FOR_UNDETERMINED, null, null, null),
        MIN_VAL_UNDETERMINED_IS_STRICT("spcLim", "min_undet_strict", "spcLim.min_undet_strict as min_undet_strict", TblsCnfg.SpecLimits.MIN_VAL_UNDETERMINED_IS_STRICT, null, null, null),
        MAX_VAL_UNDETERMINED_IS_STRICT("spcLim", "max_undet_strict", "spcLim.max_undet_strict as max_undet_strict", TblsCnfg.SpecLimits.MAX_VAL_UNDETERMINED_IS_STRICT, null, null, null),
        HAS_PREINVEST("pca", "has_pre_invest", "CASE WHEN pca.id IS NULL THEN 'NO' ELSE 'YES' END as has_pre_invest", TblsCnfg.SpecLimits.MAX_VAL_ALLOWED_IS_STRICT, null, null, null),
        PREINVEST_ID("pca", "pre_invest_id", "pca.id as id", TblsProcedure.ProgramCorrectiveAction.ID, null, null, null),
        HAS_INVEST("io", "has_invest", "CASE WHEN io.id IS NULL THEN 'NO' ELSE 'YES' END as has_invest", TblsCnfg.SpecLimits.MAX_VAL_ALLOWED_IS_STRICT, null, null, null),
        INVEST_ID("io", "invest_id", "io.invest_id as invest_id", TblsProcedure.InvestObjects.INVEST_ID, null, null, null),
        INVEST_OBJECT_ID("io", "invest_object_id", "io.id as investigation_id", TblsProcedure.InvestObjects.OBJECT_ID, null, null, null),
