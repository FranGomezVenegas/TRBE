...
public class TblsInspLotRMProcedure {
    ...
    public enum TablesInspLotRMProcedure implements EnumIntTables{        
        LOT_CORRECTIVE_ACTION(null, "lot_corrective_action", SCHEMA_NAME, IS_PRODEDURE_INSTANCE, TblsInspLotRMProcedure.LotsCorrectiveAction.values(), TblsInspLotRMProcedure.LotsCorrectiveAction.ID.getName(),
            new String[]{TblsInspLotRMProcedure.LotsCorrectiveAction.ID.getName()}, null, "Lot Corrective Action"),
        ;
        private TablesInspLotRMProcedure(FldBusinessRules[] fldBusRules, String dbTblName, String repositoryName, Boolean isProcedure, EnumIntTableFields[] tblFlds, 
    ...
    public enum LotsCorrectiveAction implements EnumIntTableFields{
        ...
        BULK_ID("bulk_id", LPDatabase.integerNotNull(), null, null, null, null),        
        BULK_NAME("bulk_name",  LPDatabase.string(100), null, null, null, null),        
        ;
        private LotsCorrectiveAction(String dbObjName, String dbObjType, String fieldMask, ReferenceFld refer, String comment,
