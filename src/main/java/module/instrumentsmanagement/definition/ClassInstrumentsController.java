...
public class ClassInstrumentsController implements ActionsClass{
    ...
    public ClassInstrumentsController(HttpServletRequest request, HttpServletResponse response, String actionName, Object[][] testingContent, Integer iLines, Integer table1NumArgs, Integer auditReasonPosic) {        
    ...
    @Override public void initializeEndpoint(String actionName) {
        try {
            this.enumConstantByName = InstrumentsEnums.InstrumentsAPIactionsEndpoints.valueOf(actionName.toUpperCase());
    ...
    @Override    public void createClassEnvMonAndHandleExceptions(HttpServletRequest request, String actionName, Object[][] testingContent, Integer iLines, Integer table1NumArgs, Integer auditReasonPosic) { 
        ClassInstruments clss = null;
        try {            
            InstrumentsEnums.InstrumentsAPIactionsEndpoints endPoint = InstrumentsEnums.InstrumentsAPIactionsEndpoints.valueOf(actionName.toUpperCase());
            ...
            clss = new ClassInstruments(request, endPoint);
