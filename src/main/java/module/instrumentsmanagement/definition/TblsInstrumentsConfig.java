...
public class TblsInstrumentsConfig {
    ...
    public enum InstrumentsFamily implements EnumIntTableFields{
        ...
        CALIB_SCHED_CREATE_OFFSET_INTVL("calib_sched_create_offset_days", LPDatabase.string(), null, null, null, null),
        ...
        PM_SCHED_CREATE_OFFSET_INTVL("pm_sched_create_offset_days", LPDatabase.string(), null, null, null, null),
