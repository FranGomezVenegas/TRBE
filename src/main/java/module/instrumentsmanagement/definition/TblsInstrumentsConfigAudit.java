 ...
 * @author User
 */
public class TblsInstrumentsConfigAudit {
    
    private static final java.lang.String SCHEMA_NAME = GlobalVariables.Schemas.CONFIG_AUDIT.getName();
    public enum TablesInstrumentsConfigAudit implements EnumIntTables{
        INSTRUMENTS_FAMILY(null, "instruments_family", SCHEMA_NAME, true, InstrumentsFamily.values(), InstrumentsFamily.AUDIT_ID.getName(),
            new String[]{InstrumentsFamily.AUDIT_ID.getName()}, null, "Audit for Instruments Family"),
        ;
        private TablesInstrumentsConfigAudit(FldBusinessRules[] fldBusRules, String dbTblName, String repositoryName, Boolean isProcedure, EnumIntTableFields[] tblFlds, 
