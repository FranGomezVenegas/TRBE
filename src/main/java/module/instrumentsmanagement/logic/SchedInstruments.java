...
public class SchedInstruments {
    ...
    public static JSONArray logNextEventWhenExpiredOrClose(String procInstanceName, Boolean readOnly) {
        ...
        Object[] dbViewExists = Rdbms.dbViewExists(procInstanceName, procInstanceName, ViewsInstrumentsData.CALIB_PM_EXPIRED_OR_EXPIRING.getRepositoryName(), ViewsInstrumentsData.CALIB_PM_EXPIRED_OR_EXPIRING.getViewName());
