...
public class ClassStudyController implements ActionsClass {
    ...
    public ClassStudyController(HttpServletRequest request, HttpServletResponse response, String actionName, Object[][] testingContent, Integer iLines, Integer table1NumArgs, Integer auditReasonPosic) {
    ...
    @Override public void initializeEndpoint(String actionName) {
        try {
            this.enumConstantByName = GenomaStudyAPIactionsEndPoints.valueOf(actionName.toUpperCase());
    ...
    @Override    public void createClassEnvMonAndHandleExceptions(HttpServletRequest request, String actionName, Object[][] testingContent, Integer iLines, Integer table1NumArgs, Integer auditReasonPosic) { 
        ClassStudy clss = null;
        try {            
            GenomaStudyAPIactionsEndPoints endPoint = GenomaStudyAPIactionsEndPoints.valueOf(actionName.toUpperCase());
            ...
            clss = new ClassStudy(request, endPoint);
