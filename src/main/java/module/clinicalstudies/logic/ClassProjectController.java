...
public class ClassProjectController implements ActionsClass {
    ...
    public ClassProjectController(HttpServletRequest request, String actionName, Object[][] testingContent, Integer iLines, Integer table1NumArgs, Integer auditReasonPosic) {
