...
//                    new LPAPIArguments("responsible", LPAPIArguments.ArgumentType.STRING.toString(), false, 9),
        ...
        */
        ;
        private DailyEntryAPIactionsEndpoints(String name, String mandatoryParams, String optionalParams, String successMessageCode, LPAPIArguments[] argums, JsonArray outputObjectTypes, String devComment, String devCommentTag) {
            this.name = name;
    ...
    public enum DailyEntryAPIqueriesEndpoints implements EnumIntEndpoints {
...
*/
        ;
        private DailyEntryAPIqueriesEndpoints(String name, String successMessageCode, LPAPIArguments[] argums, JsonArray outputObjectTypes,
    ...
    public enum DailyEntryBusinessRules implements EnumIntBusinessRules {
        ...
        private DailyEntryBusinessRules(String tgName, String areaNm, JSONArray valuesList, Boolean allowMulti, char separator,
    ...
    public enum DailyEntryErrorTrapping implements EnumIntMessages {
        ...
        private DailyEntryErrorTrapping(String errCode, String defaultTextEn, String defaultTextEs) {
    ...
    public enum DailyEntryLockingReasons {
        ...
        DailyEntryLockingReasons(String propName) {
