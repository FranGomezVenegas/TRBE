 ...
 * @author User
 */
public class TblsProjectRnDDataAudit {
    private static final java.lang.String SCHEMA_NAME = GlobalVariables.Schemas.DATA_AUDIT.getName();    
    public enum TablesProjectRnDDataAudit implements EnumIntTables{        
        PROJECT(null, "project", SCHEMA_NAME, true, Project.values(), Project.AUDIT_ID.getName(), 
            new String[]{Project.AUDIT_ID.getName()}, null, "Project table"),
        ;
        private TablesProjectRnDDataAudit(FldBusinessRules[] fldBusRules, String dbTblName, String repositoryName, Boolean isProcedure, EnumIntTableFields[] tblFlds, 
