...
/*    
    ...
    public enum ViewProcUserAndRolesNewDef implements EnumIntViewFields {
        USER_NAME("usr", TblsApp.Users.USER_NAME.getName(), "usr.user_name", TblsApp.Users.USER_NAME, null, null, null),
        EMAIL("usr", TblsApp.Users.EMAIL.getName(), "usr.email", TblsApp.Users.EMAIL, null, null, null),
        ROLE_NAME("persprof", TblsProcedure.PersonProfile.ROLE_NAME.getName(), "persprof.role_name", TblsProcedure.PersonProfile.ROLE_NAME, null, null, null),
        USER_TITLE("persprof", TblsProcedure.PersonProfile.USER_TITLE.getName(), "persprof.user_title", TblsProcedure.PersonProfile.USER_TITLE, null, null, null),
        ACTIVE("persprof", TblsProcedure.PersonProfile.ACTIVE.getName(), "persprof.active", TblsProcedure.PersonProfile.ACTIVE, null, null, null);

        private ViewProcUserAndRolesNewDef(String tblAliasInView, String name, String vwAliasName, EnumIntTableFields fldObj, String fldMask, String comment, FldBusinessRules[] busRules) {
//            try{
//            this.fldName="";
