...
public class TblsTesting {
    ...
    public enum ScriptSteps implements EnumIntTableFields{
        ...
        TIME_STARTED("time_started", LPDatabase.dateTime(), "to_char(" + "time_started" + ",'YYYY-MM-DD HH:MI')", null, null, null),
        TIME_COMPLETED("time_completed", LPDatabase.dateTime(), "to_char(" + "time_completed" + ",'YYYY-MM-DD HH:MI')", null, null, null),
        TIME_CONSUME("time_consume", LPDatabase.real(), null, null, null, null),
        ...
        ARGUMENT_11("argument_11", LPDatabase.string(), null, null, null, null),
        ARGUMENT_12("argument_12", LPDatabase.string(), null, null, null, null),
        ...
        DATE_EXECUTION("date_execution", LPDatabase.dateTime(), "to_char(" + "date_execution" + ",'YYYY-MM-DD HH:MI')", null, null, null),
    ...
    public enum ScriptsCoverage implements EnumIntTableFields{
        ...
        DATE_EXECUTION("date_execution", LPDatabase.dateTime(),"to_char(" + "date_execution" + ",'YYYY-MM-DD HH:MI')", null, "", null),
    ...
    public enum ScriptSavePoint implements EnumIntTableFields{
        ...
        SAVED_DATE("saved_date", LPDatabase.dateTimeWithDefaultNow(),"to_char(" + "saved_date" + ",'YYYY-MM-DD HH:MI')", null, "", null),
        COMMENT("comment", LPDatabase.string(),null, null, "", null),
        CONTENT("content", LPDatabase.json(),null, null, "", null),
        DATE_CREATION("date_creation", LPDatabase.dateTimeWithDefaultNow(),"to_char(" + "date_creation" + ",'YYYY-MM-DD HH:MI')", null, "", null),
        DATE_EXECUTION("date_execution", LPDatabase.dateTime(),"to_char(" + "date_execution" + ",'YYYY-MM-DD HH:MI')", null, "", null),
        TIME_STARTED("time_started", LPDatabase.dateTime(),"to_char(" + "time_started" + ",'YYYY-MM-DD HH:MI')", null, "", null),
        TIME_COMPLETED("time_completed", LPDatabase.dateTime(),"to_char(" + "time_completed" + ",'YYYY-MM-DD HH:MI')", null, "", null),
    ...
    public enum SpecScript implements EnumIntTableFields{
        ...
        ACTIVE("active", LPDatabase.booleanFld(true), null, null, null, null),
        DATE_CREATION("date_creation", LPDatabase.dateTimeWithDefaultNow(), "to_char(" + "date_creation" + ",'YYYY-MM-DD HH:MI')", null, null, null),
        SAVE_EXEC_EVID_ON_SUCCESS("save_execution_evidence_on_success", LPDatabase.booleanFld(false), null, null, null, null),        
        DATE_EXECUTION("date_execution", LPDatabase.dateTime(), "to_char(" + "date_execution" + ",'YYYY-MM-DD HH:MI')", null, null, null),
        TIME_STARTED("time_started", LPDatabase.dateTime(), "to_char(" + "time_started" + ",'YYYY-MM-DD HH:MI')", null, null, null),
        TIME_COMPLETED("time_completed", LPDatabase.dateTime(), "to_char(" + "time_completed" + ",'YYYY-MM-DD HH:MI')", null, null, null),
