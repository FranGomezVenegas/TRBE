...
public class TblsAppAudit {
    ...
    public enum Incident implements EnumIntTableFields{
        ...
        DATE("date", LPDatabase.dateTime(), "to_char( date,'YYYY-MM-DD HH:MI')", null, null, null),
        ...
        PROCEDURE_HASH_CODE("procedure_hash_code", LPDatabase.string(), null, null, null, null),
    ...
    public enum Session implements EnumIntTableFields{
        ...
        DATE_STARTED("date_started", dateTime(), "to_char( date_started,'YYYY-MM-DD HH:MI')", null, null, null),
        DATE_ENDED("date_ended", dateTime(), "to_char( date_ended,'YYYY-MM-DD HH:MI')", null, null, null),
