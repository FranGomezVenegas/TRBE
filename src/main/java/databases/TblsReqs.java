...
//        SCHEMA_PREFIX(FIELDS_NAMES_SCHEMA_PREFIX, LPDatabase.stringNotNull(), null, null, null, null),
    ...
    public enum ProcedureUserRequirements implements EnumIntTableFields{
        ...
        ESIGN_REQ("esign_req", LPDatabase.booleanFld(), null, null, null, null),
        USERCONFIRM_REQ("userconfirmation_req", LPDatabase.booleanFld(), null, null, null, null),
        ...
        BUSINESS_RULE_NAME("business_rule_name", LPDatabase.string(), null, null, null, null),
