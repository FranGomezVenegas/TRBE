...
public class TblsData {
    ...
    public enum TablesData implements EnumIntTables {
        ...
        SAMPLE_ANALYSIS_RESULT_SECONDENTRY(null, "sample_analysis_result_secondentry", SCHEMA_NAME, IS_PRODEDURE_INSTANCE, SampleAnalysisResultSecondEntry.values(), SampleAnalysisResultSecondEntry.RESULT_ID.getName(),
                new String[]{SampleAnalysisResultSecondEntry.RESULT_ID.getName()},
        ...
        SAMPLE_REVISION_TESTING_GROUP(new FldBusinessRules[]{new FldBusinessRules("procedure", "revisionTestinGroupRequired", false, false, new String[]{"ENABLED"}, null)},
                ...
                new String[]{SampleRevisionTestingGroup.SAMPLE_ID.getName(), SampleRevisionTestingGroup.TESTING_GROUP.getName()}, null, ""), //        USER_METHOD(null, "user_method", SCHEMA_NAME, IS_PRODEDURE_INSTANCE, UserMethod.values(), UserSop.SOP_ID.getName(),
    ...
    public enum Sample implements EnumIntTableFields {
        ...
        SAMPLING_DATE("sampling_date", LPDatabase.dateTime(), "to_char(" + "sampling_date" + ",'YYYY-MM-DD HH:MI')", null, null, null),
        REQS_TRACKING_SAMPLING_END("requires_tracking_sampling_end", LPDatabase.booleanFld(), null, null, null, null),
        SAMPLING_DATE_END("sampling_date_end", LPDatabase.dateTime(), "to_char(" + "sampling_date_end" + ",'YYYY-MM-DD HH:MI')", null, null, null),
        ...
        INCUBATION_INCUBATOR("incubation_incubator", LPDatabase.string(), null, null, null,
                new FldBusinessRules[]{new FldBusinessRules("procedure", "sampleIncubationMode", true, false, null, new String[]{"DISABLED"})}),
        INCUBATION_START("incubation_start", LPDatabase.dateTime(), "to_char(" + "incubation_start" + ",'YYYY-MM-DD HH:MI')", null, null,
                new FldBusinessRules[]{new FldBusinessRules("procedure", "sampleIncubationMode", true, false, null, new String[]{"DISABLED"})}),
        ...
        INCUBATION_START_TEMP_EVENT_ID("incubation_start_temp_event_id", LPDatabase.integer(), null, null, null,
                new FldBusinessRules[]{new FldBusinessRules("procedure", "sampleIncubationMode", true, false, null, new String[]{"DISABLED"})}),
        INCUBATION_END("incubation_end", LPDatabase.dateTime(), "to_char(" + "incubation_end" + ",'YYYY-MM-DD HH:MI')", null, null,
                new FldBusinessRules[]{new FldBusinessRules("procedure", "sampleIncubationMode", true, false, null, new String[]{"DISABLED"})}),
        ...
        INCUBATION2_INCUBATOR("incubation2_incubator", LPDatabase.string(), null, null, null,
                new FldBusinessRules[]{new FldBusinessRules("procedure", "sampleIncubationMode", true, false, null, new String[]{"DISABLED"})}),
        INCUBATION2_START("incubation2_start", LPDatabase.dateTime(), "to_char(" + "incubation2_start" + ",'YYYY-MM-DD HH:MI')", null, null,
                new FldBusinessRules[]{new FldBusinessRules("procedure", "sampleIncubationMode", true, false, null, new String[]{"DISABLED"})}),
        ...
        INCUBATION2_START_TEMP_EVENT_ID("incubation2_start_temp_event_id", LPDatabase.integer(), null, null, null,
                new FldBusinessRules[]{new FldBusinessRules("procedure", "sampleIncubationMode", true, false, null, new String[]{"DISABLED"})}),
        INCUBATION2_END("incubation2_end", LPDatabase.dateTime(), "to_char(" + "incubation2_end" + ",'YYYY-MM-DD HH:MI')", null, null,
                new FldBusinessRules[]{new FldBusinessRules("procedure", "sampleIncubationMode", true, false, null, new String[]{"DISABLED"})}),
    ...
    public enum SampleCoc implements EnumIntTableFields {
        ...
        CUSTODIAN(FIELDS_NAMES_CUSTODIAN, LPDatabase.string(), null, null, null, null),
        CUSTODIAN_CANDIDATE(FIELDS_NAMES_CUSTODIAN_CANDIDATE, LPDatabase.string(), null, null, null, null),
        STARTED_ON("coc_started_on", LPDatabase.dateTime(), "to_char(" + "coc_started_on" + ",'YYYY-MM-DD HH:MI')", null, null, null),
        CONFIRMED_ON(FIELDS_NAMES_COC_CONFIRMED_ON, LPDatabase.dateTime(), "to_char(" + "coc_confirmed_on" + ",'YYYY-MM-DD HH:MI')", null, null, null),
    ...
    public enum SampleRevisionTestingGroup implements EnumIntTableFields {
        ...
        READY_FOR_REVISION("ready_for_revision", LPDatabase.booleanFld(), null, null, null, null),
        REVIEWED("reviewed", LPDatabase.booleanFld(), null, null, null, null),
        REVISION_ON("revision_on", LPDatabase.dateTime(), "to_char(" + "revision_on" + ",'YYYY-MM-DD HH:MI')", null, null, null),
        REVISION_BY("revision_by", LPDatabase.string(), null, new ReferenceFld(GlobalVariables.Schemas.CONFIG.getName(), TblsAppConfig.TablesAppConfig.PERSON.getTableName(), TblsAppConfig.Person.PERSON_ID.getName()), null, null);
    ...
    public enum SampleAnalysisResult implements EnumIntTableFields {
        ...
        , ANALYST_CERTIFICATION_MODE("analyst_certification_mode", LPDatabase.String()) */ //, UNDER_DEVIATION("under_deviation", LPDatabase.Boolean()) Desviaciones aún no implementadas
    ...
    public enum CertifUserAnalysisMethod implements EnumIntTableFields {
        ...
        ASSIGNED_ON(FIELDS_NAMES_ASSIGNED_ON, LPDatabase.dateTime(), "to_char( assigned_on,'YYYY-MM-DD HH:MI')", null, null, null),
        ASSIGNED_BY("assigned_by", LPDatabase.string(), null, new ReferenceFld(GlobalVariables.Schemas.CONFIG.getName(), TblsAppConfig.TablesAppConfig.PERSON.getTableName(), TblsAppConfig.Person.PERSON_ID.getName()), null, null),
        STATUS(FIELDS_NAMES_STATUS, LPDatabase.stringNotNull(), null, null, null, null),
        CERTIFICATION_DATE("certification_date", LPDatabase.dateTime(), "to_char( certification_date,'YYYY-MM-DD HH:MI')", null, null, null),
        CERTIF_EXPIRY_DATE("certif_expiry_date", LPDatabase.dateTime(), "to_char( certif_expiry_date,'YYYY-MM-DD HH:MI')", null, null, null),
    ...
    public enum UserSop implements EnumIntTableFields {
        ...
        EXPIRATION_DATE(FIELDS_NAMES_EXPIRATION_DATE, LPDatabase.dateTime(), "to_char( expiration_date,'YYYY-MM-DD HH:MI')", null, null, null),
        SOP_NAME(FIELDS_NAMES_SOP_NAME, LPDatabase.string(), null, null, null, null),
        USER_NAME(FIELDS_NAMES_USER_NAME, LPDatabase.string(), null, null, null, null),
        LIGHT(FIELDS_NAMES_LIGHT, LPDatabase.stringNotNull(), null, null, null, null),
        CERTIF_EXPIRY_DATE("certif_expiry_date", LPDatabase.dateTime(), "to_char( certif_expiry_date,'YYYY-MM-DD HH:MI')", null, null, null),
    ...
    public enum SavedQueries implements EnumIntTableFields {
        ...
        READABLE_BY("readable_by", LPDatabase.string(), null, new ReferenceFld(GlobalVariables.Schemas.CONFIG.getName(), TblsAppConfig.TablesAppConfig.PERSON.getTableName(), TblsAppConfig.Person.PERSON_ID.getName()), null, null),
    ...
    public enum ViewSampleCocNames implements EnumIntViewFields {
        SAMPLE_ID("smp_coc", Sample.SAMPLE_ID.getName(), "smp_coc.sample_id", Sample.SAMPLE_ID, null, null, null),
        CUSTODIAN("smp_coc", FIELDS_NAMES_CUSTODIAN, "smp_coc.custodian", Sample.CUSTODIAN, null, null, null),
        CUSTODIAN_CANDIDATE("smp_coc", FIELDS_NAMES_CUSTODIAN_CANDIDATE, "smp_coc.custodian_candidate", Sample.CUSTODIAN_CANDIDATE, null, null, null),
        COC_STARTED_ON("smp_coc", "coc_started_on", "smp_coc.coc_started_on", SampleCoc.STARTED_ON, null, null, null),
        COC_CONFIRMED_ON("smp_coc", FIELDS_NAMES_COC_CONFIRMED_ON, "smp_coc.coc_confirmed_on", SampleCoc.CONFIRMED_ON, null, null, null),
        COC_CUSTODIAN_NOTES("smp_coc", "coc_custodian_notes", "smp_coc.coc_custodian_notes", SampleCoc.CUSTODIAN_NOTES, null, null, null),
        NEW_CUSTODIAN_NOTES("smp_coc", "coc_new_custodian_notes", "smp_coc.coc_new_custodian_notes", SampleCoc.NEW_CUSTODIAN_NOTES, null, null, null),
        SAMPLE_PICTURE("smp_coc", "sample_picture", "smp_coc.sample_picture", SampleCoc.SAMPLE_PICTURE, null, null, null),
        ID("smp_coc", "id", "smp_coc.id", SampleCoc.ID, null, null, null),
        STATUS("smp_coc", FIELDS_NAMES_STATUS, "smp_coc.status", SampleCoc.STATUS, null, null, null),
        CUSTODIAN_NAME("usr_custodian", "custodian_name", "usr_custodian.user_name AS custodian_name", SampleCoc.CUSTODIAN, null, null, null),
        CANDIDATE_NAME("usr_candidate", "candidate_name", "usr_candidate.user_name AS candidate_name", SampleCoc.CUSTODIAN_CANDIDATE, null, null, null),;

        private ViewSampleCocNames(String tblAliasInView, String name, String vwAliasName, EnumIntTableFields fldObj, String fldMask, String comment, FldBusinessRules[] busRules) {
            this.fldName = name;
    ...
    public enum ViewUserAndMetaDataSopView implements EnumIntViewFields {
        PROCEDURE("usr", "procedure", "'#SCHEMA_CONFIG'::text AS procedure", UserSop.USER_NAME, null, null, null),
        USER_SOP_ID("usr", "user_sop_id", "usr.user_sop_id", UserSop.USER_SOP_ID, null, null, null),
        SOP_ID("usr", "sop_id", "usr.sop_id", UserSop.SOP_ID, null, null, null),
        USER_ID("usr", FIELDS_NAMES_USER_ID, "usr.user_id", UserSop.USER_ID, null, null, null),
        SOP_LIST_ID("usr", "sop_list_id", "usr.sop_list_id", UserSop.SOP_LIST_ID, null, null, null),
        ASSIGNED_BY("usr", FIELDS_NAMES_ASSIGNED_BY, "usr.assigned_by", UserSop.ASSIGNED_BY, null, null, null),
        ASSIGNED_ON("usr", FIELDS_NAMES_ASSIGNED_ON, "usr.assigned_on", UserSop.ASSIGNED_ON, null, null, null),
        STATUS("usr", FIELDS_NAMES_STATUS, "usr.status", UserSop.STATUS, null, null, null),
        MANDATORY_LEVEL("usr", FIELDS_NAMES_MANDATORY_LEVEL, "usr.mandatory_level", UserSop.MANDATORY_LEVEL, null, null, null),
        READ_STARTED("usr", "read_started", "usr.read_started", UserSop.READ_STARTED, null, null, null),
        READ_COMPLETED("usr", "read_completed", "usr.read_completed", UserSop.READ_COMPLETED, null, null, null),
        UNDERSTOOD("usr", "understood", "usr.understood", UserSop.UNDERSTOOD, null, null, null),
        EXPIRATION_DATE("usr", FIELDS_NAMES_EXPIRATION_DATE, "usr.expiration_date", UserSop.EXPIRATION_DATE, null, null, null),
        SOP_NAME("usr", FIELDS_NAMES_SOP_NAME, "usr.sop_name", UserSop.SOP_NAME, null, null, null),
        USER_NAME("usr", FIELDS_NAMES_USER_NAME, "usr.user_name", UserSop.USER_NAME, null, null, null),
        LIGHT("usr", FIELDS_NAMES_LIGHT, "usr.light", UserSop.LIGHT, null, null, null),
        BRIEF_SUMMARY("metadata", "brief_summary", "metadata.brief_summary", TblsCnfg.SopMetaData.BRIEF_SUMMARY, null, null, null),
        FILE_LINK("metadata", "file_link", "metadata.file_link", TblsCnfg.SopMetaData.FILE_LINK, null, null, null),
        AUTHOR("metadata", "author", "metadata.author", TblsCnfg.SopMetaData.AUTHOR, null, null, null),
        CERTIFICATION_MODE("metadata", "certification_mode", "metadata.certification_mode", TblsCnfg.SopMetaData.CERTIFICATION_MODE, null, null, null),
        REVIEWER_ID("usr", UserSop.REVIEWER_ID.getName(), "usr.reviewer_id", UserSop.REVIEWER_ID, null, null, null),
        PENDING_REVIEW("usr", UserSop.PENDING_REVIEW.getName(), "usr.pending_review", UserSop.PENDING_REVIEW, null, null, null),
        REVIEWED_ON("usr", UserSop.REVIEWED_ON.getName(), "usr.reviewed_on", UserSop.REVIEWED_ON, null, null, null),
        REVIEWED_BY("usr", UserSop.REVIEWED_BY.getName(), "usr.reviewed_by", UserSop.REVIEWED_BY, null, null, null),;

        private ViewUserAndMetaDataSopView(String tblAliasInView, String name, String vwAliasName, EnumIntTableFields fldObj, String fldMask, String comment, FldBusinessRules[] busRules) {
            this.fldName = name;
            this.fldAliasInView = vwAliasName;
            this.fldMask = fldMask;
            this.fldComment = comment;
    ...
    public enum ViewUserAndAnalysisMethodCertificationView implements EnumIntViewFields {
        PROCEDURE("usr", "procedure", "'#SCHEMA_CONFIG'::text AS procedure", CertifUserAnalysisMethod.USER_NAME, null, null, null),
        ID("usr", "id", "usr.id", CertifUserAnalysisMethod.ID, null, null, null),
        USER_ID("usr", FIELDS_NAMES_USER_ID, "usr.user_id", CertifUserAnalysisMethod.USER_ID, null, null, null),
        METHOD_CODE("metadata", "code", "metadata.code", Methods.CODE, null, null, null),
        METHOD_NAME("usr", "method_name", "usr.method_name", CertifUserAnalysisMethod.METHOD_NAME, null, null, null),
        METHOD_VERSION("usr", "method_version", "usr.method_version", CertifUserAnalysisMethod.METHOD_VERSION, null, null, null),
        ASSIGNED_ON("usr", FIELDS_NAMES_ASSIGNED_ON, "usr.assigned_on", CertifUserAnalysisMethod.ASSIGNED_ON, null, null, null),
        ASSIGNED_BY("usr", FIELDS_NAMES_ASSIGNED_BY, "usr.assigned_by", CertifUserAnalysisMethod.ASSIGNED_BY, null, null, null),
        STATUS("usr", FIELDS_NAMES_STATUS, "usr.status", CertifUserAnalysisMethod.STATUS, null, null, null),
        CERTIFICATION_DATE("usr", "certification_date", "usr.certification_date", CertifUserAnalysisMethod.CERTIFICATION_DATE, null, null, null),
        CERTIF_EXPIRY_DATE("usr", "certif_expiry_date", "usr.certif_expiry_date", CertifUserAnalysisMethod.CERTIF_EXPIRY_DATE, null, null, null),
        CERTIF_STARTED("usr", "certif_started", "usr.certif_started", CertifUserAnalysisMethod.CERTIF_STARTED, null, null, null),
        CERTIF_COMPLETED("usr", "certif_completed", "usr.certif_completed", CertifUserAnalysisMethod.CERTIF_COMPLETED, null, null, null),
        SOP_NAME("usr", FIELDS_NAMES_SOP_NAME, "usr.sop_name", CertifUserAnalysisMethod.SOP_NAME, null, null, null),
        USER_NAME("usr", FIELDS_NAMES_USER_NAME, "usr.user_name", CertifUserAnalysisMethod.USER_NAME, null, null, null),
        LIGHT("usr", FIELDS_NAMES_LIGHT, "usr.light", CertifUserAnalysisMethod.LIGHT, null, null, null),
        TRAINING_ID("usr", "training_id", "usr.training_id", CertifUserAnalysisMethod.TRAINING_ID, null, null, null),
        METHOD_IS_ACTIVE("metadata", "active", "metadata.active", Methods.ACTIVE, null, null, null),
        METHOD_EXPIRES("metadata", "expires", "metadata.expires", Methods.EXPIRES, null, null, null),
        METHOD_EXPIRY_INTERVAL_INFO("metadata", "expiry_interval_info", "metadata.expiry_interval_info", Methods.EXPIRY_INTERVAL_INFO, null, null, null),
        CERTIFICATION_MODE("metadata", "certification_mode", "metadata.certification_mode", Methods.CERTIFICATION_MODE, null, null, null),;

        private ViewUserAndAnalysisMethodCertificationView(String tblAliasInView, String name, String vwAliasName, EnumIntTableFields fldObj, String fldMask, String comment, FldBusinessRules[] busRules) {
            this.fldName = name;
            this.fldAliasInView = vwAliasName;
            this.fldMask = fldMask;
            this.fldComment = comment;
    ...
    public enum ViewSampleAnalysisResultWithSpecLimits implements EnumIntViewFields {
        ...
        STATUS_PREVIOUS("sar", FIELDS_NAMES_STATUS_PREVIOUS, "sar.status_previous", SampleAnalysisResult.STATUS_PREVIOUS, null, null, null),
        ANALYSIS("sar", FIELDS_NAMES_ANALYSIS, "sar.analysis", SampleAnalysisResult.ANALYSIS, null, null, null),
        METHOD_NAME("sar", LPDatabase.FIELDS_NAMES_METHOD_NAME, "sar.method_name", SampleAnalysisResult.METHOD_NAME, null, null, null),
        METHOD_VERSION("sar", LPDatabase.FIELDS_NAMES_METHOD_VERSION, "sar.method_version", SampleAnalysisResult.METHOD_VERSION, null, null, null),
        REPLICA("sar", FIELDS_NAMES_REPLICA, "sar.replica", SampleAnalysisResult.REPLICA, null, null, null),
        ...
        MANDATORY("sar", "mandatory", "sar.mandatory", SampleAnalysisResult.MANDATORY, null, null, null),
        REQUIRES_LIMIT("sar", "requires_limit", "sar.requires_limit", SampleAnalysisResult.REQUIRES_LIMIT, null, null, null),
        ...
        ENTERED_ON("sar", "entered_on", "sar.entered_on", SampleAnalysisResult.ENTERED_ON, null, null, null),
        ENTERED_BY("sar", "entered_by", "sar.entered_by", SampleAnalysisResult.ENTERED_BY, null, null, null),
        REENTERED("sar", "reentered", "sar.reentered", SampleAnalysisResult.REENTERED, null, null, null),
        SPEC_EVAL("sar", FIELDS_NAMES_SPEC_EVAL, "sar.spec_eval", SampleAnalysisResult.SPEC_EVAL, null, null, null),
        SPEC_EVAL_DETAIL("sar", "spec_eval_detail", "sar.spec_eval_detail", SampleAnalysisResult.SPEC_EVAL_DETAIL, null, null, null),
        UOM("sar", "uom", "sar.uom", SampleAnalysisResult.UOM, null, null, null),
        UOM_CONVERSION_MODE("sar", "uom_conversion_mode", "sar.uom_conversion_mode", SampleAnalysisResult.UOM_CONVERSION_MODE, null, null, null),
        ALIQUOT_ID("sar", FIELDS_NAMES_ALIQUOT_ID, "sar.aliquot_id", SampleAnalysisResult.ALIQUOT_ID, null, null, null),
        SUBALIQUOT_ID("sar", FIELDS_NAMES_SUBALIQUOT_ID, "sar.subaliquot_id", SampleAnalysisResult.SUBALIQUOT_ID, null, null, null),
        MAX_DP("sar", "max_dp", "sar.max_dp", SampleAnalysisResult.MAX_DP, null, null, null),
        MIN_ALLOWED("sar", "min_allowed", "sar.min_allowed", SampleAnalysisResult.MIN_ALLOWED, null, null, null),
        MAX_ALLOWED("sar", "max_allowed", "sar.max_allowed", SampleAnalysisResult.MAX_ALLOWED, null, null, null),
        LIST_ENTRY("sar", "list_entry", "sar.list_entry", SampleAnalysisResult.LIST_ENTRY, null, null, null),
        ...
        PROGRAM_NAME("s", "program_name", "s.program_name", TblsEnvMonitData.Sample.PROGRAM_NAME, null, null, null),
        SAMPLING_DATE("s", "sampling_date", "s.sampling_date", Sample.SAMPLING_DATE, null, null, null),
        SHIFT("s", "shift", "s.shift", TblsEnvMonitData.Sample.SHIFT, null, null, null),
        AREA("s", "area", "s.area", TblsEnvMonitData.Sample.AREA, null, null, null),
        LOCATION_NAME("s", "location_name", "s.location_name", TblsEnvMonitData.Sample.LOCATION_NAME, null, null, null),
        PRODUCTION_LOT("s", "production_lot", "s.production_lot", TblsEnvMonitData.Sample.PRODUCTION_LOT, null, null, null),
        PROGRAM_DAY_ID("s", "program_day_id", "s.program_day_id", TblsEnvMonitData.Sample.PROG_DAY_ID, null, null, null),
        PROGRAM_DAY_DATE("s", "program_day_date", "s.program_day_date", TblsEnvMonitData.Sample.PROG_DAY_DATE, null, null, null),
        SAMPLE_ANALYSIS_STATUS("sa", "sample_analysis_status", "sa.status  AS sample_analysis_status", SampleAnalysis.STATUS, null, null, null),
        ...
        TESTING_GROUP("sa", "testing_group", "sa.testing_group", SampleAnalysis.TESTING_GROUP, null, null, null),
        LOGGED_ON("s", "logged_on", "s.logged_on", Sample.LOGGED_ON, null, null, null),
        LOGGED_BY("s", "logged_by", "s.logged_by", Sample.LOGGED_BY, null, null, null),
        SAMPLER("s", "sampler", "s.sampler", Sample.SAMPLER, null, null, null),
        SAMPLER_AREA("s", "sampler_area", "s.sampler_area", TblsEnvMonitData.Sample.SAMPLER_AREA, null, null, null),
        ...
        LIMIT_ID("spcLim", "limit_id", "spcLim.limit_id", SpecLimits.LIMIT_ID, null, null, null),
        SPEC_CODE("spcLim", "spec_code", "spcLim.code AS spec_code", SpecLimits.CODE, null, null, null),
        SPEC_CONFIG_VERSION("spcLim", "spec_config_version", "spcLim.config_version AS spec_config_version", SpecLimits.CONFIG_VERSION, null, null, null),
        SPEC_VARIATION_NAME("spcLim", "spec_variation_name", "spcLim.variation_name AS spec_variation_name", SpecLimits.VARIATION_NAME, null, null, null),
        ANALYSIS_SPEC_LIMITS("spcLim", "analysis_spec_limits", "spcLim.analysis AS analysis_spec_limits", SpecLimits.ANALYSIS, null, null, null),
        METHOD_NAME_SPEC_LIMITS("spcLim", "method_name_spec_limits", "spcLim.method_name AS method_name_spec_limits", SpecLimits.METHOD_NAME, null, null, null),
        METHOD_VERSION_SPEC_LIMITS("spcLim", "method_version_spec_limits", "spcLim.method_version AS method_version_spec_limits", SpecLimits.METHOD_VERSION, null, null, null),
        PARAMETER("spcLim", "parameter", "spcLim.parameter", SpecLimits.PARAMETER, null, null, null),
        RULE_TYPE("spcLim", "rule_type", "spcLim.rule_type", SpecLimits.RULE_TYPE, null, null, null),
        RULE_VARIABLES("spcLim", "rule_variables", "spcLim.rule_variables", SpecLimits.RULE_VARIABLES, null, null, null),
        UOM_SPEC_LIMITS("spcLim", "uom_spec_limits", "spcLim.uom AS uom_spec_limits", SpecLimits.UOM, null, null, null),
        UOM_CONVERSION_MODE_SPEC_LIMITS("spcLim", "uom_conversion_mode_spec_limits", "spcLim.uom_conversion_mode AS uom_conversion_mode_spec_limits", SpecLimits.UOM_CONVERSION_MODE, null, null, null),
        MIN_VAL_ALLOWED("spcLim", "min_val_allowed", "spcLim.min_val_allowed", SpecLimits.MIN_VAL_ALLOWED, null, null, null),
        MAX_VAL_ALLOWED("spcLim", "max_val_allowed", "spcLim.max_val_allowed", SpecLimits.MAX_VAL_ALLOWED, null, null, null),
        MIN_VAL_ALLOWED_IS_STRICT("spcLim", "min_allowed_strict", "spcLim.min_allowed_strict", SpecLimits.MIN_VAL_ALLOWED_IS_STRICT, null, null, null),
        MAX_VAL_ALLOWED_IS_STRICT("spcLim", "max_allowed_strict", "spcLim.max_allowed_strict", SpecLimits.MAX_VAL_ALLOWED_IS_STRICT, null, null, null),
        MIN_VAL_FOR_UNDETERMINED("spcLim", "min_undetermined", "spcLim.min_undetermined", SpecLimits.MIN_VAL_FOR_UNDETERMINED, null, null, null),
        MAX_VAL_FOR_UNDETERMINED("spcLim", "max_undetermined", "spcLim.max_undetermined", SpecLimits.MAX_VAL_FOR_UNDETERMINED, null, null, null),
        MIN_VAL_UNDETERMINED_IS_STRICT("spcLim", "min_undet_strict", "spcLim.min_undet_strict", SpecLimits.MIN_VAL_UNDETERMINED_IS_STRICT, null, null, null),
        MAX_VAL_UNDETERMINED_IS_STRICT("spcLim", "max_undet_strict", "spcLim.max_undet_strict", SpecLimits.MAX_VAL_UNDETERMINED_IS_STRICT, null, null, null),
        HAS_PREINVEST("pca", "has_pre_invest", "CASE WHEN pca.id IS NULL THEN 'NO'::text "
                + " ELSE 'YES'::text END AS has_pre_invest", SpecLimits.MAX_VAL_ALLOWED_IS_STRICT, null, null, null),
        PREINVEST_ID("pca", "pre_invest_id", "pca.id AS pre_invest_id", ProgramCorrectiveAction.ID, null, null, null),
        HAS_INVEST("io", "has_invest", "CASE WHEN io.id IS NULL THEN 'NO'::text "
                + " ELSE 'YES'::text END AS has_invest", SpecLimits.MAX_VAL_ALLOWED_IS_STRICT, null, null, null),
        INVEST_ID("io", "invest_id", "io.invest_id", InvestObjects.INVEST_ID, null, null, null),
        INVEST_OBJECT_ID("io", "invest_object_id", "io.id AS invest_object_id", InvestObjects.OBJECT_ID, null, null, null),
        SAMPLE_REVIEWER("s", "sample_reviewer", "s.reviewer AS sample_reviewer", Sample.REVIEWER, null, null, null),
        TEST_REVIEWER("sa", "test_reviewer", "sa.reviewer  AS test_reviewer", SampleAnalysis.REVIEWER, null, null, null),
        SAR2_RESULT_ID("sar2", "sar2_" + SampleAnalysisResult.RESULT_ID.getName(), "sar2.result_id AS sar2_result_id", SampleAnalysisResult.RESULT_ID, null, null, null),
        SAR2_TEST_ID("sar2", "sar2_" + SampleAnalysis.TEST_ID.getName(), "sar2.test_id AS sar2_test_id", SampleAnalysisResult.TEST_ID, null, null, null),
        SAR2_SAMPLE_ID("sar2", "sar2_" + Sample.SAMPLE_ID.getName(), "sar2.sample_id AS sar2_sample_id", SampleAnalysisResult.SAMPLE_ID, null, null, null),
        SAR2_STATUS("sar2", "sar2_" + FIELDS_NAMES_STATUS, "sar2.status AS sar2_status", SampleAnalysisResult.STATUS, null, null, null),
        SAR2_STATUS_PREVIOUS("sar2", "sar2_" + FIELDS_NAMES_STATUS_PREVIOUS, "sar2.status_previous AS sar2_status_previous", SampleAnalysisResult.STATUS_PREVIOUS, null, null, null),
        SAR2_ANALYSIS("sar2", "sar2_" + FIELDS_NAMES_ANALYSIS, "sar2.analysis AS sar2_analysis", SampleAnalysisResult.ANALYSIS, null, null, null),
        SAR2_METHOD_NAME("sar2", "sar2_" + LPDatabase.FIELDS_NAMES_METHOD_NAME, "sar2.method_name AS sar2_method_name", SampleAnalysisResult.METHOD_NAME, null, null, null),
        SAR2_METHOD_VERSION("sar2", "sar2_" + LPDatabase.FIELDS_NAMES_METHOD_VERSION, "sar2.method_version AS sar2_method_version", SampleAnalysisResult.METHOD_VERSION, null, null, null),
        SAR2_REPLICA("sar2", "sar2_" + FIELDS_NAMES_REPLICA, "sar2.replica AS sar2_replica", SampleAnalysisResult.REPLICA, null, null, null),
        SAR2_PARAM_NAME("sar2", "sar2_" + "param_name", "sar2.param_name AS sar2_param_name", SampleAnalysisResult.PARAM_NAME, null, null, null),
        SAR2_PARAM_TYPE("sar2", "sar2_" + "param_type", "sar2.param_type AS sar2_param_type", SampleAnalysisResult.PARAM_TYPE, null, null, null),
        SAR2_MANDATORY("sar2", "sar2_" + "mandatory", "sar2.mandatory AS sar2_mandatory", SampleAnalysisResult.MANDATORY, null, null, null),
        SAR2_REQUIRES_LIMIT("sar2", "sar2_" + "requires_limit", "sar2.requires_limit AS sar2_requires_limit", SampleAnalysisResult.REQUIRES_LIMIT, null, null, null),
        SAR2_RAW_VALUE("sar2", "sar2_" + "raw_value", "sar2.raw_value AS sar2_raw_value", SampleAnalysisResult.RAW_VALUE, null, null, null),
        SAR2_RAW_VALUE_NUM("sar2", "sar2_" + "raw_value_num",
                "CASE "
                ...
                SampleAnalysisResult.REPLICA, null, null, null),
        SAR2_PRETTY_VALUE("sar2", "sar2_" + "pretty_value", "sar2.pretty_value AS sar2_pretty_value", SampleAnalysisResult.PRETTY_VALUE, null, null, null),
        SAR2_ENTERED_ON("sar2", "sar2_" + "entered_on", "sar2.entered_on AS sar2_entered_on", SampleAnalysisResult.ENTERED_ON, null, null, null),
        SAR2_ENTERED_BY("sar2", "sar2_" + "entered_by", "sar2.entered_by AS sar2_entered_by", SampleAnalysisResult.ENTERED_BY, null, null, null),
        SAR2_REENTERED("sar2", "sar2_" + "reentered", "sar2.reentered AS sar2_reentered", SampleAnalysisResult.REENTERED, null, null, null),
        SAR2_SPEC_EVAL("sar2", "sar2_" + FIELDS_NAMES_SPEC_EVAL, "sar2.spec_eval AS sar2_spec_eval", SampleAnalysisResult.SPEC_EVAL, null, null, null),
        SAR2_SPEC_EVAL_DETAIL("sar2", "sar2_" + "spec_eval_detail", "sar2.spec_eval_detail AS sar2_spec_eval_detail", SampleAnalysisResult.SPEC_EVAL_DETAIL, null, null, null),
        SAR2_UOM("sar2", "sar2_" + "uom", "sar2.uom AS sar2_uom", SampleAnalysisResult.UOM, null, null, null),
        SAR2_SAR2_UOM_CONVERSION_MODE("sar2", "sar2_" + "uom_conversion_mode", "sar2.uom_conversion_mode AS sar2_uom_conversion_mode", SampleAnalysisResult.UOM_CONVERSION_MODE, null, null, null),
        SAR2_ALIQUOT_ID("sar2", "sar2_" + FIELDS_NAMES_ALIQUOT_ID, "sar2.aliquot_id AS sar2_aliquot_id", SampleAnalysisResult.ALIQUOT_ID, null, null, null),
        SAR2_SUBALIQUOT_ID("sar2", "sar2_" + FIELDS_NAMES_SUBALIQUOT_ID, "sar2.subaliquot_id AS sar2_subaliquot_id", SampleAnalysisResult.SUBALIQUOT_ID, null, null, null),
        SAR2_MAX_DP("sar2", "sar2_" + "max_dp", "sar2.max_dp AS sar2_max_dp", SampleAnalysisResult.MAX_DP, null, null, null),
        SAR2_MIN_ALLOWED("sar2", "sar2_" + "min_allowed", "sar2.min_allowed AS sar2_min_allowed", SampleAnalysisResult.MIN_ALLOWED, null, null, null),
        SAR2_MAX_ALLOWED("sar2", "sar2_" + "max_allowed", "sar2.max_allowed AS sar2_max_allowed", SampleAnalysisResult.MAX_ALLOWED, null, null, null),
        SAR2_LIST_ENTRY("sar2", "sar2_" + "list_entry", "sar2.list_entry AS sar2_list_entry", SampleAnalysisResult.LIST_ENTRY, null, null, null),        
        ;
