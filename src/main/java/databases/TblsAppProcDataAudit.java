...
public class TblsAppProcDataAudit {
    ...
    public enum TablesAppProcDataAudit implements EnumIntTables{
        INSTRUMENTS(null, "instruments", SCHEMA_NAME, true, Instruments.values(), Instruments.FLD_AUDIT_ID.getName(),
            new String[]{Instruments.FLD_AUDIT_ID.getName()}, null, "Audit for User Sessions"),
        ;
    ...
    public enum Instruments implements EnumIntTableFields{
        ...
        FLD_INSTRUMENT_NAME("instrument_name", LPDatabase.stringNotNull(), null, null, null, null),
        ...
        FLD_ACTION_PRETTY_EN("action_pretty_en", LPDatabase.string(), null, null, null, null),
        FLD_ACTION_PRETTY_ES("action_pretty_es", LPDatabase.string(), null, null, null, null),
        ;
