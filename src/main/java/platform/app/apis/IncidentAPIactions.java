...
public class IncidentAPIactions extends HttpServlet {
    ...
    public enum IncidentAPIqueriesEndpoints implements EnumIntEndpoints {
        ...
        private IncidentAPIqueriesEndpoints(String name, String successMessageCode, LPAPIArguments[] argums, JsonArray outputObjectTypes, String devComment, String devCommentTag) {
            this.name = name;
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (endPoint) {
                case NEW_INCIDENT:
                    ...
                    RdbmsObject diagnostic = AppIncident.newIncident(argValues[0].toString(), argValues[1].toString(), argValues[2].toString(), argValues[3].toString(), argValues[4].toString(), jsonObject);
