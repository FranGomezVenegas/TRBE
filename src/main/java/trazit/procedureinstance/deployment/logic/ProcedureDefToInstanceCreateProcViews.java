...
public class ProcedureDefToInstanceCreateProcViews {
    ...
    public static JsonObject viewTabs(Integer solId, Object[] curView, String currentParentCode, String currentCode, String windowType,
    String procedure, Integer procVersion, String procInstanceName){
        ...
        for (Object[] curTab: solTabs){
            JsonObject curTabModel = viewTableWithButtons(solId, Integer.valueOf(curTab[0].toString()), curView, currentParentCode, currentCode, windowType,
    ...
    public static JsonObject viewTableWithButtons(Integer solId, Integer tabId, Object[] curView, String currentParentCode, String currentCode, String windowType,
    String procedure, Integer procVersion, String procInstanceName){
        ...
        try {
            ...
            jObjModel=viewAddGridButtons(jObjModel, vwProcReqSolFlds, procViewsArr[0]);
    ...
    public static JsonObject viewAddGridButtons(JsonObject curModel, EnumIntTableFields[] flds, Object[] values){
