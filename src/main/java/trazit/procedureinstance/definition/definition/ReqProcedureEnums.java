...
public class ReqProcedureEnums {
    ...
    public enum ProcedureDefinitionAPIActionsEndpoints implements EnumIntEndpoints {
        ...
        NEW_REQ_SOLUTION("NEW_REQ_SOLUTION", "newRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_VERSION.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 7),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROC_INSTANCENAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 8),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.REQUIREMENT_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9),
        ...
        ADD_WINDOW_BUTTON_REQ_SOLUTION("ADD_WINDOW_BUTTON_REQ_SOLUTION", "addWindowButtonRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    ...
                    new LPAPIArguments("orderNumber", LPAPIArguments.ArgumentType.BIGDECIMAL.toString(), false, 14),
                    new LPAPIArguments("roleName", LPAPIArguments.ArgumentType.STRING.toString(), false, 15),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_NAME, LPAPIArguments.ArgumentType.STRINGARR.toString(), false, 16),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_VALUE, LPAPIArguments.ArgumentType.STRINGOFOBJECTS.toString(), false, 17)
                }, EndPointsToRequirements.endpointWithNoOutputObjects,                null, null),
        ...
        ADD_WINDOW_REQ_SOLUTION("ADD_WINDOW_REQ_SOLUTION", "addWindowRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    ...
                    new LPAPIArguments("contentType", LPAPIArguments.ArgumentType.STRING.toString(), false, 14),
                    new LPAPIArguments("orderNumber", LPAPIArguments.ArgumentType.BIGDECIMAL.toString(), false, 15),
                    new LPAPIArguments("roleName", LPAPIArguments.ArgumentType.STRING.toString(), true, 16),
                    new LPAPIArguments("sopName", LPAPIArguments.ArgumentType.STRING.toString(), false, 17),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_NAME, LPAPIArguments.ArgumentType.STRINGARR.toString(), false, 18),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_VALUE, LPAPIArguments.ArgumentType.STRINGOFOBJECTS.toString(), false, 19)
                }, EndPointsToRequirements.endpointWithNoOutputObjects,                null, null),
        ...
        UPDATE_REQ_SOLUTION("UPDATE_REQ_SOLUTION", "updateRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_VERSION.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 7),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROC_INSTANCENAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 8),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.REQUIREMENT_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9),
        ...
        VIEW_UPDATE_REQ_SOLUTION_MAIN_INFO("VIEW_UPDATE_REQ_SOLUTION_MAIN_INFO", "updateRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_VERSION.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 7),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROC_INSTANCENAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 8),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.REQUIREMENT_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9),
        ...
        VIEW_UPDATE_TBL_W_BUTTONS_MAIN_INFO("VIEW_UPDATE_TBL_W_BUTTONS_MAIN_INFO", "updateRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_VERSION.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 7),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROC_INSTANCENAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 8),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.REQUIREMENT_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.SOLUTION_ID.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 10),
                    new LPAPIArguments("tableId", LPAPIArguments.ArgumentType.INTEGER.toString(), true, 11),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_NAME, LPAPIArguments.ArgumentType.STRINGARR.toString(), false, 12),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_VALUE, LPAPIArguments.ArgumentType.STRINGOFOBJECTS.toString(), false, 13)
                }, EndPointsToRequirements.endpointWithNoOutputObjects,                null, null),
        VIEW_UPDATE_ICON_INFO("VIEW_UPDATE_ICON_INFO", "updateRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_VERSION.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 7),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROC_INSTANCENAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 8),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.REQUIREMENT_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.SOLUTION_ID.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 10),
                    new LPAPIArguments("tableId", LPAPIArguments.ArgumentType.INTEGER.toString(), true, 11),
                    new LPAPIArguments("posicId", LPAPIArguments.ArgumentType.INTEGER.toString(), false, 12),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_NAME, LPAPIArguments.ArgumentType.STRINGARR.toString(), false, 13),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_VALUE, LPAPIArguments.ArgumentType.STRINGOFOBJECTS.toString(), false, 14)
                }, EndPointsToRequirements.endpointWithNoOutputObjects,                null, null),
        VIEW_ADD_TBL_ENDPOINT_PARAM("VIEW_ADD_TBL_ENDPOINT_PARAM", "updateRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_VERSION.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 7),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROC_INSTANCENAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 8),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.REQUIREMENT_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.SOLUTION_ID.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 10),
                    new LPAPIArguments("tableId", LPAPIArguments.ArgumentType.INTEGER.toString(), true, 11),
                    new LPAPIArguments("argumentName", LPAPIArguments.ArgumentType.STRING.toString(), true, 12),
                    new LPAPIArguments("argumentValue", LPAPIArguments.ArgumentType.STRING.toString(), true, 13),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_NAME, LPAPIArguments.ArgumentType.STRINGARR.toString(), false, 14),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_VALUE, LPAPIArguments.ArgumentType.STRINGOFOBJECTS.toString(), false, 15)
                }, EndPointsToRequirements.endpointWithNoOutputObjects,                null, null),
        VIEW_UPDATE_TBL_ENDPOINT_PARAM("VIEW_UPDATE_TBL_ENDPOINT_PARAM", "updateRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_VERSION.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 7),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROC_INSTANCENAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 8),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.REQUIREMENT_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9),
                    ...
                    new LPAPIArguments("tableId", LPAPIArguments.ArgumentType.INTEGER.toString(), true, 11),
                    new LPAPIArguments("argumentName", LPAPIArguments.ArgumentType.STRING.toString(), true, 12),
                    new LPAPIArguments("newArgumentValue", LPAPIArguments.ArgumentType.STRING.toString(), true, 13),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_NAME, LPAPIArguments.ArgumentType.STRINGARR.toString(), false, 14),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_VALUE, LPAPIArguments.ArgumentType.STRINGOFOBJECTS.toString(), false, 15)
                }, EndPointsToRequirements.endpointWithNoOutputObjects,                null, null),
        VIEW_REMOVE_TBL_ENDPOINT_PARAM("VIEW_REMOVE_TBL_ENDPOINT_PARAM", "updateRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_VERSION.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 7),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROC_INSTANCENAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 8),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.REQUIREMENT_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9),
        ...
        VIEW_ADD_TBL_ENDPOINT_PARAM_SUBFILTER("VIEW_ADD_TBL_ENDPOINT_PARAM_SUBFILTER", "updateRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_VERSION.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 7),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROC_INSTANCENAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 8),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.REQUIREMENT_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9),
                    ...
                    new LPAPIArguments("tableId", LPAPIArguments.ArgumentType.INTEGER.toString(), true, 11),
                    new LPAPIArguments("posicId", LPAPIArguments.ArgumentType.INTEGER.toString(), false, 12),
                    new LPAPIArguments("argumentName", LPAPIArguments.ArgumentType.STRING.toString(), true, 13),
                    new LPAPIArguments("argumentValue", LPAPIArguments.ArgumentType.STRING.toString(), true, 14),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_NAME, LPAPIArguments.ArgumentType.STRINGARR.toString(), false, 15),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_VALUE, LPAPIArguments.ArgumentType.STRINGOFOBJECTS.toString(), false, 16)
                }, EndPointsToRequirements.endpointWithNoOutputObjects,                null, null),
        VIEW_UPDATE_TBL_ENDPOINT_PARAM_SUBFILTER("VIEW_UPDATE_TBL_ENDPOINT_PARAM_SUBFILTER", "updateRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_VERSION.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 7),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROC_INSTANCENAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 8),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.REQUIREMENT_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9),
        ...
        VIEW_ADD_TBL_GRID_COLUMN("VIEW_ADD_TBL_GRID_COLUMN", "updateRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_VERSION.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 7),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROC_INSTANCENAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 8),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.REQUIREMENT_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9),
        ...
        VIEW_UPDATE_TBL_GRID_COLUMN("VIEW_UPDATE_TBL_GRID_COLUMN", "updateRequirementSolutionToProcedure_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_VERSION.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 7),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROC_INSTANCENAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 8),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.REQUIREMENT_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9),
                    ...
                    new LPAPIArguments("tableId", LPAPIArguments.ArgumentType.INTEGER.toString(), true, 11),
                    new LPAPIArguments("posicId", LPAPIArguments.ArgumentType.INTEGER.toString(), false, 12),
                    new LPAPIArguments("fieldName", LPAPIArguments.ArgumentType.STRING.toString(), true, 13),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_NAME, LPAPIArguments.ArgumentType.STRINGARR.toString(), false, 14),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_VALUE, LPAPIArguments.ArgumentType.STRINGOFOBJECTS.toString(), false, 15)
                }, EndPointsToRequirements.endpointWithNoOutputObjects,                null, null),
        ...
        SCRIPT_UPDATE_STEP("SCRIPT_UPDATE_STEP", "updatedScriptStepTesting_success",
                new LPAPIArguments[]{new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 6),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROCEDURE_VERSION.getName(), LPAPIArguments.ArgumentType.INTEGER.toString(), true, 7),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.PROC_INSTANCENAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 8),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.SCRIPT_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9),
                    new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.STEP_ID.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 10),
                    new LPAPIArguments("action", LPAPIArguments.ArgumentType.STRING.toString(), true, 11),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_NAME, LPAPIArguments.ArgumentType.STRINGARR.toString(), false, 12),
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_SAMPLE_FIELD_VALUE, LPAPIArguments.ArgumentType.STRINGOFOBJECTS.toString(), false, 13),
                    new LPAPIArguments("expectedSyntaxis", LPAPIArguments.ArgumentType.STRING.toString(), false, 14),
                    new LPAPIArguments("expectedNotification", LPAPIArguments.ArgumentType.STRING.toString(), false, 15),                        
                    new LPAPIArguments("alternativeToken", LPAPIArguments.ArgumentType.STRING.toString(), false, 16)
                }, EndPointsToRequirements.endpointWithNoOutputObjects,                null, null),        
