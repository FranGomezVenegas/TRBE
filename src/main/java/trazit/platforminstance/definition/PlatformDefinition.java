...
public class PlatformDefinition {
    ...
    public enum PlatformDefinitionAPIactionsEndpoints implements EnumIntEndpoints {
        ...
        private PlatformDefinitionAPIactionsEndpoints(String name, String successMessageCode, LPAPIArguments[] argums, String devComment, String devCommentTag) {
            this.name = name;
        ...
        public String getApiUrl() {
            return ApiUrls.PLATFORM_DEFINITION_ACTIONS.getUrl();
        }
