...
public class QueryUtilitiesEnums {
    public static Object[][] getTableData(EnumIntTables tblObj, EnumIntTableFields[] fldsToRetrieve, String[] whereFldName, Object[] whereFldValue, String[] orderBy){        
        ...
        Object[][] tblInfo=getRecordFieldsByFilter(tblObj, fldsToRetrieve, whereFldName, whereFldValue, orderBy, false);
        return tblInfo;
    }    
    private static Object[][] getRecordFieldsByFilter(EnumIntTables tblObj, EnumIntTableFields[] fieldsToRetrieve, String[] whereFieldNames, Object[] whereFieldValues, String[] orderBy, Boolean inforceDistinct){
    ...
    public static Object[][] getViewData(ProcedureRequestSession procReqSession, String schema, String tableName,  String fldToRetrieve,  EnumIntViewFields[] tableAllFields, String[] whereFldName, Object[] whereFldValue, String[] orderBy){        
        //String[] fieldsToRetrieve=getFieldsListToRetrieve(fldToRetrieve, tableAllFields);
        Object[][] tblInfo=getViewRecordFieldsByFilter(LPPlatform.buildSchemaName(procReqSession.getProcedureInstance(), schema), 
                tableName, whereFldName, whereFldValue, tableAllFields, orderBy, false);
        return tblInfo;
    }    
    public static Object[][] getViewRecordFieldsByFilter(String schemaName, String tableName, String[] whereFieldNames, Object[] whereFieldValues, EnumIntViewFields[] fieldsToRetrieve, String[] orderBy, Boolean inforceDistinct){
        schemaName=addSuffixIfItIsForTesting(schemaName, tableName);           
        if (whereFieldNames.length==0){
           Object[] diagnosesError = ApiMessageReturn.trapMessage(LPPlatform.LAB_FALSE, Rdbms.RdbmsErrorTrapping.RDBMS_NOT_FILTER_SPECIFIED, new Object[]{tableName, schemaName});                         
           return LPArray.array1dTo2d(diagnosesError, diagnosesError.length);               
