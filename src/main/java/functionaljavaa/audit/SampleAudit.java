...
public class SampleAudit {       
    ...
    public enum DataSampleAnalysisAuditEvents implements EnumIntAuditEvents{ SAMPLE_ANALYSIS_REVIEWED, SAMPLE_ANALYSIS_EVALUATE_STATUS, SAMPLE_ANALYSIS_ANALYST_ASSIGNMENT, 
        SAMPLE_ANALYSIS_ADDED, SAMPLE_ANALYSIS_REMOVED, SAMPLE_ANALYSIS_CANCELED, SAMPLE_ANALYSIS_UNCANCELED, SAMPLE_ANALYSIS_UNREVIEWED, SAMPLE_ANALYSIS_SET_READY_FOR_REVISION, SAMPLE_ANALYSIS_AUTOAPPROVE}
    
    public enum DataSampleAnalysisResultAuditEvents implements EnumIntAuditEvents{BACK_FROM_CANCEL, SAMPLE_ANALYSIS_RESULT_ENTERED, SAMPLE_ANALYSIS_RESULT_ENTERED_CALC, SAMPLE_ANALYSIS_RESULT_REENTERED, SAMPLE_ANALYSIS_RESULT_REENTERED_CALC, SAMPLE_ANALYSIS_RESULT_ENTERED_SECONDENTRY, SAMPLE_ANALYSIS_RESULT_REENTERED_SECONDENTRY,
        SAMPLE_ANALYSIS_RESULT_ADDED, SAMPLE_ANALYSIS_RESULT_CANCELED, SAMPLE_ANALYSIS_RESULT_UNCANCELED, SAMPLE_ANALYSIS_RESULT_REVIEWED, SAMPLE_ANALYSIS_RESULT_UNREVIEWED, UOM_CHANGED,
...
*/        
    ...
    public static InternalMessage sampleAuditRevisionPass(Integer sampleId){
        ...
        if ("YES".equalsIgnoreCase(auditRevisionChildRequired)){
    ...
    public static InternalMessage sampleAuditRevisionPassByAction(String procInstanceName, String actionName, Integer sampleId, Integer testId, Integer resultId){
        ...
        if ("YES".equalsIgnoreCase(auditChildRevisionMode))
            whereFieldName=LPArray.addValueToArray1D(whereFieldName, TblsDataAudit.Sample.PARENT_AUDIT_ID.getName()+WHERECLAUSE_TYPES.IS_NULL.getSqlClause());
