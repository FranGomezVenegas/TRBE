...
public class ConfigTablesAudit {
    ...
    public enum ConfigAnalysisAuditEvents implements EnumIntAuditEvents {
        ANALYSIS_NEW, ANALYSIS_UPDATE, ANALYSIS_DEACTIVATED, ANALYSIS_REACTIVATED, APPROVED_FOR_USE, UNAPPROVED_FOR_USE,
        ANALYSIS_METHOD_ADDED, ANALYSIS_METHOD_UPDATE, ANALYSIS_METHOD_DELETE,
