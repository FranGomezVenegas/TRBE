...
public class ClassInvestigationController implements ActionsClass{
    ...
    public ClassInvestigationController(HttpServletRequest request, HttpServletResponse response, String actionName, Object[][] testingContent, Integer iLines, Integer table1NumArgs, Integer auditReasonPosic) {
    ...
    @Override public void initializeEndpoint(String actionName) {
        try {
            this.enumConstantByName = InvestigationAPI.InvestigationAPIactionsEndpoints.valueOf(actionName.toUpperCase());
    ...
    @Override    public void createClassEnvMonAndHandleExceptions(HttpServletRequest request, String actionName, Object[][] testingContent, Integer iLines, Integer table1NumArgs, Integer auditReasonPosic) {   
        ClassInvestigation clss = null;
        try {            
            InvestigationAPI.InvestigationAPIactionsEndpoints endPoint =InvestigationAPI.InvestigationAPIactionsEndpoints.valueOf(actionName.toUpperCase());
            ...
            clss = new ClassInvestigation(request, endPoint);
