...
public static InternalMessage addDateToCalendar(String code, Date newDate, String dayName, String[] fldNames, Object[] fldValues){   
        ...
        Object[] existsRecord = Rdbms.existsRecord(GlobalVariables.Schemas.APP.getName(), TblsApp.HolidaysCalendarDate.TBL.getName(), 
        ...
        Object[] calAddDateCreationDiagn = Rdbms.insertRecordInTable(GlobalVariables.Schemas.APP.getName(), TblsApp.HolidaysCalendarDate.TBL.getName(), 
                fldNames, fldValues);
...
public static InternalMessage deleteCalendarDate(String code, Integer dateId){   
        ...
        Object[] removeRecordInTable = Rdbms.removeRecordInTable(GlobalVariables.Schemas.APP.getName(), TblsApp.HolidaysCalendarDate.TBL.getName(), 
            new String[]{TblsApp.HolidaysCalendarDate.FLD_CALENDAR_CODE.getName(), TblsApp.HolidaysCalendarDate.FLD_ID.getName()},
            new Object[]{code, dateId});
