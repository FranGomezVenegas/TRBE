...
public class HolidaysCalendarEnums {
    ...
    public enum CalendarAPIqueriesEndpoints implements EnumIntEndpoints {
        GET_ALL_HOLIDAY_DATES_LIST_ALL_CALENDARS("GET_ALL_HOLIDAY_DATES_LIST_ALL_CALENDARS", "", new LPAPIArguments[]{}, EndPointsToRequirements.endpointWithNoOutputObjects,
                null, null),
        DEACTIVATED_HOLIDAY_CALENDARS_LAST_N_DAYS("DEACTIVATED_HOLIDAY_CALENDARS_LAST_N_DAYS", "", new LPAPIArguments[]{new LPAPIArguments(REQUEST_PARAM_NUM_DAYS, LPAPIArguments.ArgumentType.INTEGER.toString(), false, 6),}, EndPointsToRequirements.endpointWithNoOutputObjects,
                null, null),
        ;
