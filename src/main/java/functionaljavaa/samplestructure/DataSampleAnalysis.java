    ...
    public static Object[] sampleAnalysisReview(Integer sampleId, Integer testId) {
        ...
        if ((!(sampleAnalysisStatusCanceled.equalsIgnoreCase(currStatus))) && (!(sampleAnalysisStatusReviewed.equalsIgnoreCase(currStatus))) && (testId != null)) {
            ...
            if (LPPlatform.LAB_TRUE.equalsIgnoreCase(diagnoses[0].toString())) {
                ...
                sampleAnalysisEvaluateStatusAutomatismForReview(sampleId, testId, SampleAudit.DataSampleAnalysisAuditEvents.SAMPLE_ANALYSIS_REVIEWED.toString(), (Integer) sampleAuditAdd[sampleAuditAdd.length-1]);
            }
            return diagnoses;
        } else {
