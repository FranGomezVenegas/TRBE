...
*/
    ...
    public static InternalMessage newIncubator(String instName, String incubStage, BigDecimal minTemp, BigDecimal maxTemp, String[] fldNames, Object[] fldValues){
    ProcedureRequestSession instanceForActions = ProcedureRequestSession.getInstanceForActions(null, null, null);
        ...
        if (LPPlatform.LAB_TRUE.equalsIgnoreCase(instrInfo[0][0].toString()))
            return new InternalMessage(LPPlatform.LAB_FALSE, ConfigIncubatorErrorTrapping.ALREADY_EXISTS, new Object[]{instName, procInstanceName});
        ...
        if (minTemp!=null&&maxTemp!=null&&minTemp.compareTo(maxTemp)>0)
            return new InternalMessage(LPPlatform.LAB_FALSE, ConfigIncubatorErrorTrapping.MIN_GREATERTHAN_MAX_TEMP, new Object[]{instName, procInstanceName});
        ...
        if (Boolean.FALSE.equals(insertRecord.getRunSuccess()))
            ...
            return new InternalMessage(LPPlatform.LAB_TRUE, EnvMonIncubatorAPIactionsEndpoints.EM_INCUBATOR_NEW, new Object[]{instName, procInstanceName});
    }    
     ...
     * @return
     */
    public static InternalMessage activateIncubator(String instName, String personName){
        ...
        if (Boolean.TRUE.equals(Boolean.valueOf(instrInfo[0][1].toString())))
            return new InternalMessage(LPPlatform.LAB_FALSE, ConfigIncubatorErrorTrapping.ALREADY_ACTIVE, new Object[]{instName, procInstanceName}); 
	...
	RdbmsObject incubUpdate=Rdbms.updateTableRecordFieldsByFilter(TblsEnvMonitConfig.TablesEnvMonitConfig.INSTRUMENT_INCUBATOR,
        ...
        if (Boolean.FALSE.equals(incubUpdate.getRunSuccess())) 
            return new InternalMessage(incubUpdate.getRunSuccess()?LPPlatform.LAB_TRUE:LPPlatform.LAB_FALSE, incubUpdate.getErrorMessageCode(), incubUpdate.getErrorMessageVariables(), null);  
        return DataIncubatorNoteBook.activation(instName, personName); 
    }    
     ...
     * @return
     */
    public static InternalMessage deactivateIncubator(String instName, String personName){
        String procInstanceName=ProcedureRequestSession.getInstanceForActions(null, null, null).getProcedureInstance();
        Object[][] instrInfo=Rdbms.getRecordFieldsByFilter(procInstanceName, LPPlatform.buildSchemaName(procInstanceName, GlobalVariables.Schemas.CONFIG.getName()), TblsEnvMonitConfig.TablesEnvMonitConfig.INSTRUMENT_INCUBATOR.getTableName(), 
                new String[]{TblsEnvMonitConfig.InstrIncubator.NAME.getName()}, new Object[]{instName}, 
                new String[]{TblsEnvMonitConfig.InstrIncubator.NAME.getName(), TblsEnvMonitConfig.InstrIncubator.ACTIVE.getName()});
	...
	RdbmsObject incubUpdate=Rdbms.updateTableRecordFieldsByFilter(TblsEnvMonitConfig.TablesEnvMonitConfig.INSTRUMENT_INCUBATOR,
        ...
        if (Boolean.FALSE.equals(incubUpdate.getRunSuccess())) 
            return new InternalMessage(incubUpdate.getRunSuccess()?LPPlatform.LAB_TRUE:LPPlatform.LAB_FALSE, incubUpdate.getErrorMessageCode(), incubUpdate.getErrorMessageVariables(), null);  
        return DataIncubatorNoteBook.deactivation(instName, personName); 
    }    
