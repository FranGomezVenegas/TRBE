...
public class ReqProcedureDefinitionQueries extends HttpServlet {
                ...
                case ALL_PROCEDURES_DEFINITION:
                    ...
                    for (Object[] curProc : procAndInstanceArr) {
                        ...
                        if (valuePosicInArray > -1) {
                            ...
                            curProcObj.put("testing", procInstanceTestingInfo(curProc[valuePosicInArray].toString()));
                        }
    ...
    private static JSONObject procInstanceTestingInfo(String procInstanceName) {
        JSONObject jMainObj = new JSONObject();
        JSONArray dbRowsToJsonArr = ClassReqProcedureQueries.dbRowsToJsonArr(LPPlatform.buildSchemaName(procInstanceName, TblsTesting.TablesTesting.SCRIPT.getRepositoryName()), TblsTesting.TablesTesting.SCRIPT.getTableName(),
                getAllFieldNames(TblsTesting.TablesTesting.SCRIPT.getTableFields()), new String[]{TblsTesting.Script.ACTIVE.getName()}, new Object[]{true},
                null, new String[]{});
        jMainObj.put("scripts", dbRowsToJsonArr);
        dbRowsToJsonArr = ClassReqProcedureQueries.dbRowsToJsonArr(LPPlatform.buildSchemaName(procInstanceName, TblsTesting.TablesTesting.SCRIPTS_COVERAGE.getRepositoryName()),TblsTesting.TablesTesting.SCRIPTS_COVERAGE.getTableName(),
                getAllFieldNames(TblsTesting.TablesTesting.SCRIPTS_COVERAGE.getTableFields()), new String[]{TblsTesting.ScriptsCoverage.ACTIVE.getName()}, new Object[]{true},
                null, new String[]{});
        jMainObj.put("coverage", dbRowsToJsonArr);
        return jMainObj;
    }            
...
/*        jMainObj.put("user_requirements", ClassReqProcedureQueries.dbRowsToJsonArr(GlobalVariables.Schemas.REQUIREMENTS.getName(), TblsReqs.TablesReqs.PROCEDURE_USER_REQS.getTableName(),
