...
public class ReqProcedureEnums {
    ...
    public enum ReqProcedureDefinitionAPIQueriesEndpoints implements EnumIntEndpoints{
        ALL_PROCEDURES_AND_INSTANCE_LIST("ALL_PROCEDURES_AND_INSTANCE_LIST", "",new LPAPIArguments[]{}, EndPointsToRequirements.endpointWithNoOutputObjects),
        ALL_USER_PROCEDURES_DEFINITION("ALL_USER_PROCEDURES_DEFINITION", "",new LPAPIArguments[]{}, EndPointsToRequirements.endpointWithNoOutputObjects),
        ...
        PROC_DEPLOY_TESTING_COVERAGE_SUMMARY("PROC_DEPLOY_TESTING_COVERAGE_SUMMARY", "deployRequirements_success", 
                ...
                new LPAPIArguments(ProcedureDefinitionpParametersEndpoints.DB_NAME.getName(), LPAPIArguments.ArgumentType.STRING.toString(), true, 9)}, EndPointsToRequirements.endpointWithNoOutputObjects),
        ;
        private ReqProcedureDefinitionAPIQueriesEndpoints(String name, String successMessageCode, LPAPIArguments[] argums, JsonArray outputObjectTypes){
            this.name=name;
            this.successMessageCode=successMessageCode;
            this.arguments=argums;  
            this.outputObjectTypes=outputObjectTypes;            
