...
public class ClassSampleQueriesController implements ActionsClass{
    ...
    @Override public void initializeEndpoint(String actionName) {
        try {
            this.enumConstantByName = SampleAPIParams.SampleAPIqueriesEndpoints.valueOf(actionName.toUpperCase());
    ...
    @Override    public void createClassEnvMonAndHandleExceptions(HttpServletRequest request, String actionName, Object[][] testingContent, Integer iLines, Integer table1NumArgs, Integer auditReasonPosic) {
        ...
        try {            
            SampleAPIParams.SampleAPIqueriesEndpoints endPoint = SampleAPIParams.SampleAPIqueriesEndpoints.valueOf(actionName.toUpperCase());
