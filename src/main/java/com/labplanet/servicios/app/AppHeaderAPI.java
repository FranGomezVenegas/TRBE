...
public class AppHeaderAPI extends HttpServlet {
    ...
    public enum AppHeaderAPIqueriesEndpoints implements EnumIntEndpoints {
        GETAPPHEADER("GETAPPHEADER", "",
                new LPAPIArguments[]{
                    new LPAPIArguments(GlobalAPIsParams.REQUEST_PARAM_PERSON_FIELDS_NAME, LPAPIArguments.ArgumentType.STRING.toString(), false, 6, null, null)}, EndPointsToRequirements.endpointWithNoOutputObjects
                 , null, null),
        ;
        private AppHeaderAPIqueriesEndpoints(String name, String successMessageCode, LPAPIArguments[] argums, JsonArray outputObjectTypes, String devComment, String devCommentTag) {
            this.name = name;
